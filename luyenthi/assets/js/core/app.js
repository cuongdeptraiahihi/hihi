...
$(function() {
    ...
    $('.sidebar-mobile-main-toggle').on('click', function (e) {
        e.preventDefault();
        if($(window).width() <= 770 && !$(this).hasClass("sidebar-admin")) {
            ...
            if (!body.hasClass("sidebar-mobile-main")) {
                ...
                $(".page-container, .navbar").animate({marginLeft: "80%",marginRight: "-80%"}, "fast", "linear");
            } else {
            ...
            body.removeClass('sidebar-mobile-secondary sidebar-mobile-opposite');
        } else {
