      	...
      	<div id="BODY">
            ...
            <div id="MAIN">
            	...
            	<div class="main-div back animated bounceInUp" id="main-top">
                    <div id="main-person">
                        <h1 style="line-height:98px;">Xin nghỉ học</h1>
                        <div class="clear"></div>
                    </div>
                    <div id="main-avata">
                ...
                <form action="https://localhost/www/TDUONG/xin-nghi-hoc/" method="post" enctype="multipart/form-data">
                        ...
                        <ul>
                            <li id="chart-li1" class="li-3">
                                ...
                                <ul style="margin-top:3px;">
                                    <li>
                                        <div style="width:100%;margin-top:0;text-align:center;"><p>Ảnh tin nhắn xin nghỉ</p></div>
                                    </li>
                                    <li>
                            ...
                            <li id="chart-li1" class="li-3">
                                ...
                                <ul style="margin-top:3px;">
                                    <li>
                                        <div style="width:100%;margin-top:0;text-align:center;"><p>Nhập SĐT phụ huynh đã dùng để nhắn tin xin nghỉ</p></div>
                                    </li>
                                    <li>
                            ...
                            <li id="main-tb" class="li-3">
                                <div class="main-2 back"><h3>Bước 3</h3></div>
                                <ul style="margin-top:3px;">
                                    <li><div style="width:100%;text-align:center;"><p>Ngày xin nghỉ, có dạng ngày/tháng/năm</p></div></li>
                                    <li>
                                        <div style="width: 100%;">
