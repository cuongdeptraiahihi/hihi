...
require("../../model/model.php");
	...
	if (isset($_GET["search2"])) {
		...
		if(mysqli_num_rows($result)==0) {
			...
			while($data=mysqli_fetch_assoc($result)) {
				echo"<li><a href='http://localhost/www/TDUONG/admin/thuong/$data[ID_HS]/' data-hsID='$data[ID_HS]'>$data[cmt] - $data[fullname]</a></li>";
			}
		}
	}
	...
	if (isset($_GET["search3"])) {
		...
		if(mysqli_num_rows($result)==0) {
			...
			while($data=mysqli_fetch_assoc($result)) {
				echo"<li><a href='http://localhost/www/TDUONG/admin/phat/$data[ID_HS]/' data-hsID='$data[ID_HS]'>$data[cmt] - $data[fullname]</a></li>";
			}
		}
	}
