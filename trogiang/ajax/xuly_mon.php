    ...
    if(isset($_POST["lmID4"])) {
        ...
        for($i=0;$i<count($result);$i++) {
            echo"<tr>
                ...
                <th style='background: #EF5350;width:10%;min-width:70px;'><span><a href='http://localhost/www/TDUONG/admin/hoc-sinh-chi-tiet/ma/".$result[$i]["cmt"]."/' target='_blank'>".$result[$i]["cmt"]."</a></span></th>
    ...
    if(isset($_POST["note_load"])) {
        ...
        while($data=mysqli_fetch_assoc($result)) {
            ...
            echo "<tr>
                ...
                <th style='background: #EF5350;width:10%;'><span><a href='http://localhost/www/TDUONG/admin/hoc-sinh-chi-tiet/ma/$data[maso]/' target='_blank'>$data[maso]</a></span></td>
...
//                    <th><span><a href='" . formatFacebook($data["facebook"]) . "' target='_blank' class='link-face'>$data[fullname]</a><br /><a href='http://localhost/www/TDUONG/admin/hoc-sinh-chi-tiet/ma/$data[maso]/' target='_blank'>$data[maso]</a></span></th>
...
//                    <td><span><a href='" . formatFacebook($data["facebook"]) . "' target='_blank' class='link-face'>$data[fullname]</a><br /><a href='http://localhost/www/TDUONG/admin/hoc-sinh-chi-tiet/ma/$data[maso]/' target='_blank'>$data[maso]</a></span></td>
