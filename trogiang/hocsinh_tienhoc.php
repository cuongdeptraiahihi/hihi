...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>       
        ...
        <link rel="stylesheet" href="http://localhost/www/TDUONG/trogiang/css/jquery-ui.css">
                ...
                $("#nap-tien").click(function() {
                    ...
                    if(cmt!="" && cmt.length>=7 && ngay!="" && oID!="") {
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                if(result!="none") {
                                    $("#info-action").html("<tr style='background:none;'><th colspan='6'><span>Nạp tiền</span></th></tr><tr><td style='width:15%;'><span>Số tiền nạp</span></td><td style='width:25%;'><input type='number' class='input tien' min='0' placeholder='10000, 20000, ..' /></td><td style='width:15%;'><input type='text' class='input seri' placeholder='Seri hóa đơn' /></td><td style='width:15%;'><span>Ngày đóng</span></td><td><input type='text' class='input date_dong' placeholder='12/4/2016' value='<?php echo date("d/m/Y"); ?>' /></td><td style='width:15%;'><input type='submit' class='submit' id='ok-nap' value='Nạp tiền' /></td></tr>"+result);
                                } else {
                                    alert("Không tồn tại học sinh này!");
                                }
                                $("#popup-loading").fadeOut("fast");
            ...
            <div id="MAIN">
                <div id="main-mid">
              	<div class="main-div back animated bounceInUp" id="main-top">
                	<div id="main-person">
                		<h1 style="line-height:98px;">NHẬP TIỀN HỌC</h1>
                        <div class="clear"></div>
                   	</div>
                    <div id="main-avata">
                ...
                <div class="main-div animated bounceInUp status">
                    <div id="main-info">
                    	<div class="main-1-left back" style="margin-right:2%;">
                        	<div>
                            	<p class="main-title">Tra cứu - Thông tin trợ giảng</p>
                            </div>
                            <table class="table-tkb" id="info-baomat">
                                <tr>
                                    <td style="width:35%;"><span>Ngày nhập</span></td>
                        ...
                        <div class="main-1-left back">
                            ...
                            <table class="table-tkb" id="info-hs" style="position:relative;">
                                <tr>
                        ...
                        <div class="main-div animated bounceInUp">
                            <div id="main-info">
                                <div class="main-1-left back" style="margin-right:2%;width:100%;padding-top:2px;padding-bottom:2px;margin-top:15px;">
                                    <table class="table-tkb" style="width:100%;display:none;" id="info-thaotac">
                                        <tr><th colspan="3"><span>Thao tác</span></th></tr>
                                        <tr>
                        ...
                        <div class="main-div animated bounceInUp">
                            <div id="main-info">
                                <div class="main-1-left back" style="margin-right:2%;width:100%;padding-top:2px;padding-bottom:2px;margin-top:15px;">
                                    <table class="table-tkb" id="info-action" style="width:100%;">
                                    </table>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="main-div animated bounceInUp">
                            <div id="main-info">
                                <div class="main-1-left back" style="margin-top:15px;margin-right:2%;width:100%;padding-top:2px;">
                                    <table class="table-tkb" style="width:100%;" id="info-lichsu">
                                        <tr><th colspan="6"><span>Lịch sử nhập trong ngày</span></th></tr>
                                    </table>
                                </div>
                            </div>
                        </div>
