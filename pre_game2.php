    ...
    <div id="BODY">
        ...
        <div id="MAIN">
            ...
            <div class="main-div back animated bounceInUp" id="main-top">
                <div id="main-person">
                  <h1 style='line-height:98px;'>Nhóm phát vé</h1>
                    <div class="clear"></div>
                </div>
                <div id="main-avata">
            ...
            <div class="main-div animated bounceInUp">
                <ul>
                    <li id="chart-li1" class="li-2">
                        ...
                        <ul style="margin-top:3px;">
                            <form action="https://localhost/www/TDUONG/nhom-phat-ve/" method="post">
                                <li>
                    ...
                    <li id="chart-li1" class="li-2">
                        ...
                        <ul style="margin-top:3px;">
                            <?php
                                $n=count($ngayarr);
                                for($i=0;$i<$n;$i++) {
//                                    $query2="SELECT * FROM options WHERE content='$ngayarr[$i]' AND type='buoi-phat-ve'";
//                                    $result2=mysqli_query($db,$query2);
...
//                                    }
                            ...
                            ?>
                                    <li onclick="location.href='https://localhost/www/TDUONG/phat-ve/<?php echo $ngayarr[$i]; ?>/'" style="cursor: pointer;">
                                        <div style="width: 20%;text-align: center;vertical-align: top;margin-top: 50px;"><p style="font-size: 22px;">BUỔI <?php echo ($i+1); ?></p></div>
                                        ...
                                        <div style="width: 60%;vertical-align: top;margin-top: 35px;"><p style="margin-left: 15px;line-height: 22px;">
                        ...
                        <ul style="margin-top:3px;">
                            <form action="https://localhost/www/TDUONG/nhom-phat-ve/" method="post">
                                <?php if($check_game) { ?>
                                    ...
                                    <li>
                                        <div style="width: 20%;"><p><i class="fa fa-credit-card" style="width:25px;"></i>Tên</p></div>
                                        <div style="width: 78%;"><input type="text" name="name" id="name" placeholder="Tên nhóm" autocomplete="off" style="width:96%;padding:2%" class="input" /></div>
                                    </li>
                                    <li>
                                        <div style="width: 20%;"><p><i class="fa fa-lock" style="width:25px;"></i>Mật khẩu</p></div>
                                        <div style="width: 78%;"><input type="password" name="pass" id="pass" placeholder="Mật khẩu (nếu muốn)" autocomplete="off" style="width:96%;padding:2%" class="input" /></div>
                                    </li>
                                    <li>
