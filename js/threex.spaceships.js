...
THREEx.SpaceShips.loadSpaceFighter01	= function(onLoad){
	...
	var objUrl	= baseUrl + 'TDUONG/include/SpaceFighter01/SpaceFighter01.obj';
	var mtlUrl	= baseUrl + 'TDUONG/include/SpaceFighter01/SpaceFighter01.mtl';
...
THREEx.SpaceShips.loadSpaceFighter02	= function(onLoad){
	var loader	= new THREE.OBJMTLLoader();
	var baseUrl	= THREEx.SpaceShips.baseUrl 
	var objUrl	= baseUrl + 'TDUONG/include/SpaceFighter02/SpaceFighter02.obj';
	var mtlUrl	= baseUrl + 'TDUONG/include/SpaceFighter02/SpaceFighter02.mtl';
	loader.load(objUrl, mtlUrl, function( object3d ){
...
THREEx.SpaceShips.loadSpaceFighter03	= function(onLoad){
	var loader	= new THREE.OBJMTLLoader();
	var baseUrl	= THREEx.SpaceShips.baseUrl 
	var objUrl	= baseUrl + 'TDUONG/include/SpaceFighter03/SpaceFighter03.obj';
	var mtlUrl	= baseUrl + 'TDUONG/include/SpaceFighter03/SpaceFighter03.mtl';
	loader.load(objUrl, mtlUrl, function( object3d ){
...
THREEx.SpaceShips.loadShuttle01	= function(onLoad){
	var loader	= new THREE.OBJMTLLoader();
	var baseUrl	= THREEx.SpaceShips.baseUrl 
	var objUrl	= baseUrl + 'TDUONG/include/Shuttle01/Shuttle01.obj';
	var mtlUrl	= baseUrl + 'TDUONG/include/Shuttle01/Shuttle01.mtl';
	loader.load(objUrl, mtlUrl, function( object3d ){
...
THREEx.SpaceShips.loadShuttle02	= function(onLoad){
	var loader	= new THREE.OBJMTLLoader();
	var baseUrl	= THREEx.SpaceShips.baseUrl 
	var objUrl	= baseUrl + 'TDUONG/include/Shuttle02/Shuttle02.obj';
	var mtlUrl	= baseUrl + 'TDUONG/include/Shuttle02/Shuttle02.mtl';
	loader.load(objUrl, mtlUrl, function( object3d ){
		object3d.scale.multiplyScalar(1/400)
		// change emissive color of all object3d material - they are too dark
		object3d.traverse(function(object3d){
...
THREEx.SpaceShips.Detonation	= function(){
	var baseUrl	= THREEx.SpaceShips.baseUrl 
	var url		= baseUrl + 'TDUONG/images/lensflare0_alpha.png';
