...
<div id="NAVBAR">
	<ul>
    	<li style="background:#FFF;"><a href="https://localhost/www/TDUONG/" title="Trang chủ"><i class="fa fa-home"></i></a></li>
        <li style="background:#FFF;" class="li-con"><a href="https://localhost/www/TDUONG/dang-xuat/" title="Đăng xuất"><i class="fa fa-sign-out"></i></a></li>
    </ul>
</div>
...
//                location.reload();
                ...
                window.location.href="https://localhost/www/TDUONG/dang-xuat/";
            }
        });
    };
