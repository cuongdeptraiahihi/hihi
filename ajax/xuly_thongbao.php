	    ...
	    if($action=="get") {
            ...
            if($_SESSION["show_tien"]==1) {
                ...
                echo"<ol style='width:100%;'>
                    <a href='https://localhost/www/TDUONG/tai-khoan/' style='margin-left:10px;float:left;color:#000;font-size:14px;font-weight:600;'>Tài khoản: ".format_price($tien)."</a>
                    <a href='https://localhost/www/TDUONG/level/' style='margin-right:10px;float:right;color:#000;font-size:14px;font-weight:600;'>LVL: ".get_level($hsID,$lmID)."</a>
                </ol>
                <div class='clear'></div>
                </a></li>";
            }
