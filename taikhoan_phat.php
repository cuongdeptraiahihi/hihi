      	...
      	<div id="BODY">
            ...
            <div id="MAIN">
              	...
              	<div class="main-div back animated bounceInUp" id="main-top">
                	<div id="main-person">
                		<h1 style="line-height:98px;">Lịch sử trừ tiền</h1>
                        <div class="clear"></div>
                   	</div>
                    <div id="main-avata">
					...
					<div class="page-number back">
						...
						<?php
							if($current!=1) {
								...
								echo"<li><a href='https://localhost/www/TDUONG/tai-khoan-phat/page-$prev/'><</a></li>";
							}
							for($page=1;$page<=$sum_page;$page++) {
								$begin=($page-1)*$display;
								if($page==$current) {
									echo"<li style='background:rgba(0,0,0,0.35);'><a href='https://localhost/www/TDUONG/tai-khoan-phat/page-$begin/' style='font-weight:600;'>$page</a></li>";
								} else {
									echo"<li><a href='https://localhost/www/TDUONG/tai-khoan-phat/page-$begin/'>$page</a></li>";
								}
							}
							if($current!=$sum_page) {
								$next=$position+$display;
								echo"<li><a href='https://localhost/www/TDUONG/tai-khoan-phat/page-$next/'>></a></li>";
							}
						?>
						</ul>
					</div>
