      	...
      	<div id="BODY">
            ...
            <div id="MAIN">
              	...
              	<div class="main-div back animated bounceInUp" id="main-top">
                	<div id="main-person">
                		<h1 style="line-height:98px;">Lịch sử đăng nhập</h1>
                        <div class="clear"></div>
                   	</div>
                    <div id="main-avata">
                ...
                <div class="main-div animated bounceInUp">
                	<div class="main-1 back" style="border-bottom:none;border-bottom-left-radius:0;border-bottom-right-radius:0;"><h3>Có <?php echo count_log($hsID,"login");?> lần đăng nhập</h3></div>
                    <div id="main-table">
                    	<table>
