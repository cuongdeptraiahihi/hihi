...
//                            $query="SELECT ID_N FROM nhom_de WHERE object='$buoiID'";
...
//                            INNER JOIN de_thi AS t ON t.ID_DE=n.ID_DE AND t.nhom='$nhom' AND t.main='1'
...
//                            $result = mysqli_query($db, $query);
//                            while($data=mysqli_fetch_assoc($result)) {
//                                $loaide_arr[$data["ID_D"]]=$data["name"];
//                            }
//
...
//                                echo $highestRow."<br />";
                                echo $worksheet->getCellByColumnAndRow(0,1)->getValue();
//                                for ($row = 2; $row <= 3; $row++) {
//                                    $html .= "<tr>";
//
//                                    $temp=$worksheet->getCellByColumnAndRow(0, $row)->getValue();
...
//                                        $query0 = "SELECT h.ID_HS,m.ID_LM,m.de,k.ID_DIEM FROM hocsinh AS h
...
//
//                                            $query = "SELECT n.ID_C,n.ID_DE,n.sort AS csort,a.sort AS dsort,t.loai FROM de_noi_dung AS n
//                                            INNER JOIN de_thi AS t ON t.ID_DE=n.ID_DE AND t.maso='$made' AND t.nhom='$nhom'
...
//                                                while ($data = mysqli_fetch_assoc($result)) {
//                                                    if ($data0["de"] != $loaide_arr[$data["loai"]] && $data["csort"] == 1) {
//                                                        break;
//                                                    }
...
//                                            }
//
//                                            $query5="SELECT h.ID_CA FROM ca_hientai AS h WHERE h.ID_HS='$data0[ID_HS]' AND h.cum='$cum'";
