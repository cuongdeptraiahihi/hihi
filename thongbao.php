                ...
                <div class="main-div animated bounceInUp">
                    ...
                    <div id="main-table">
                    	<table>
                            <tr class="back">
                                <td colspan="2"></td>
                                <td colspan="2"><input type="submit" class="submit" value="Lịch sử đăng nhập" onclick="location.href='https://localhost/www/TDUONG/lich-su-dang-nhap/'" /></td>
                                <td colspan="2"><input type="submit" class="submit" value="Lịch sử đổi ca" onclick="location.href='https://localhost/www/TDUONG/lich-su-doi-ca/'" /></td>
                            </tr>
								...
								while($data=mysqli_fetch_assoc($result)) {
									echo"<tr class='back'>
										...
										if($data["status"]=="new") {
											...
											echo"<td><span>Mới</td>
											<td><button class='submit daxem' data-tbID='$data[ID_TB]'><i class='fa fa-bell-slash'></i></button></td>";
										} else if($data["status"]=="freezee"){
											echo"<td><span>Đóng băng</span></td>
											<td></td>";
										} else {
											echo"<td><span>Đã xem</span></td>
											<td><button class='submit chuaxem' data-tbID='$data[ID_TB]'><i class='fa fa-bell-o'></i></button></td>";
										}
									echo"</tr>";
									$stt++;
								}
					...
					<div class="page-number back">
						...
						<?php
							if($current!=1) {
								...
								echo"<li><a href='https://localhost/www/TDUONG/thong-bao/page-$prev/'><</a></li>";
							}
							for($page=1;$page<=$sum_page;$page++) {
								$begin=($page-1)*$display;
								if($page==$current) {
									echo"<li style='background:rgba(0,0,0,0.35);'><a href='https://localhost/www/TDUONG/thong-bao/page-$begin/' style='font-weight:600;'>$page</a></li>";
								} else {
									echo"<li><a href='https://localhost/www/TDUONG/thong-bao/page-$begin/'>$page</a></li>";
								}
							}
							if($current!=$sum_page) {
								$next=$position+$display;
								echo"<li><a href='https://localhost/www/TDUONG/thong-bao/page-$next/'>></a></li>";
							}
						?>
						</ul>
					</div>
