...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>       
        ...
        <script>
			...
			$(document).ready(function(){$("#echo_count").html("<span>"+$("#count_thachdau").val()+"</span>"),$("#send").click(function(){return confirm("Bạn có chắc chắn chọn ngôi sao hy vọng? Bạn sẽ bị trừ tiền cược và hoàn lại nếu bạn thắng!")?($("#send").hide(),tien = $("#tien-coc").val(),$("#loading").fadeIn("fast"),$("#BODY").css("opacity","0.3"),$.ajax({url:"http://localhost/www/TDUONG/mobile/xuly-ngoisao/",async:!1,data:"ngoisao=" + tien,type:"post",success:function(t){$("#loading").fadeOut("fast"),$("#BODY").css("opacity","1"),alert(t),location.reload()}}),!1):void 0}),$("#main-tb ul li .td-action button.delete").click(function(){return confirm("Bạn có chắc chắn muốn hủy ngôi sao hy vọng?")?(nsID=$(this).attr("data-nsID"),del_li=$(this).closest("li"),$.ajax({url:"http://localhost/www/TDUONG/mobile/xuly-ngoisao/",async:!1,data:"nsID="+nsID,type:"post",success:function(t){$("#loading").fadeOut("fast"),$("#BODY").css("opacity","1"),""==t?del_li.fadeOut("fast"):alert(t)}}),!1):void 0})});
			<?php } ?>
		</script>
      	...
      	<div id="SIDEBACK"><div id="BODY">
            ...
            <div id="MAIN">
                ...
                <div class="main-div animated bounceInUp">
                	<ul>
                    	<li id="chart-li1" class="li-1">
                        	<div class="main-2 back"><h3>Ngôi sao hy vọng</h3></div>
                            <ul style="margin-top:3px;">
                            	<li>
                                	<div style="width:100%;text-align:center;"><p>X2 số tiền thưởng trong bài kiểm tra tiếp theo.</p></div>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <div style="width:50%;"><p>Tiên thưởng (đ)</p></div>
                                </li>
                                <li>
                    ...
                    <div id="main-table">
                    	<table>
                        	<tr id="table-head" class="back tr-big">
                                <th style="width:25%;"><span>Ngày</span></th>
                                <th style="width:50%;"><span>Kết quả</span></th>
                                <th style="width:25%;"><span>Điểm</span></th>
                      		</tr>
                            <?php
								$result=get_history_ngoisao($hsID,$lmID);
								while($data=mysqli_fetch_assoc($result)) {
									$ngay=format_date($data["buoi"]);
									$hs1=mysqli_fetch_assoc(get_hs_short_detail($data["ID_HS"], $lmID));
									$who_win=$data["ketqua"];
									if($who_win==1) {
