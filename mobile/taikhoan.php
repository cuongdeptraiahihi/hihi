...
//        $checkAK = validAccountKit($hsID,$data0["sdt"],$ak_code);
        ...
        header("location:http://localhost/www/TDUONG/mobile/tai-khoan/");
        exit();
    }
?>
        ...
        <script>
            $(document).ready(function() {
                ...
                $("#send-tien").click(function() {
                    var me = $(this);
                    var maso = me.closest("table").find("tr td input#maso").val();
                    var tien = me.closest("table").find("tr td input#tien").val();
        ...
        <div id="SIDEBACK"><div id="BODY">
            ...
            <div id="MAIN">
              	...
              	<div class="main-div back animated bounceInUp" id="main-top">
                	<div id="main-person">
                		<h1>Quản lý tài khoản<br /><span><?php echo format_price(get_tien_hs($hsID));?></span></h1>
                        <div class="clear"></div>
                   	</div>
                    ...
                    <div class="main-div animated animated2 bounceInUp">
                        <div id="main-info">
                            <div class="main-1-left back" style="padding: 10px 0;">
                                ...
                                <form action="http://localhost/www/TDUONG/mobile/tai-khoan/" method="post" id="my_form">
...
<!--                            <div class="main-1-left back" style="padding: 10px 0;">-->
<!--                                <div>-->
<!--                                    <p class="main-title">Xin nghỉ học</p>-->
<!--                                </div>-->
<!--                                <table class="table-tkb">-->
<!--                                    <tr>-->
<!--                                        <td style="background: none;"><input type="text" class="input" placeholder="Ngày nghỉ" /></td>-->
<!--                                    </tr>-->
<!--                                    <tr>-->
<!--                                        <td style="background: none;"><input type="submit" class="submit" value="Xin nghỉ" /></td>-->
<!--                                    </tr>-->
<!--                                </table>-->
<!--                            </div>-->
                        </div>
                    ...
                    <div id="main-info">
                    	<div class="main-1-left back" style="margin-right:2%;">
                            ...
                            <table class="table-tkb">
                            	<tr style='background:<?php echo $mauall; ?>;text-transform:uppercase;'>
                                    ...
                                    <th><span>+<?php echo format_money_vnd(get_thuong_hs($hsID)); ?></span></th>
                                </tr>
                            	<tr style='background:<?php echo $mauall; ?>;text-transform:uppercase;'>
                                    <th style="width:70%;"><span class="fa fa-align-left"></span></th>
                                    <th style="width:25%;"><span class="fa fa-money"></span></th>
                                </tr>
								<?php
                                    $total1=0;
                                ...
                                <tr style="background:<?php echo $mauall; ?>">
                                	<th colspan="2"><a href="http://localhost/www/TDUONG/mobile/tai-khoan-thuong/"><span>Xem tất cả</span></a></th>
                                </tr>
                          	</table>
                       	</div>
                        <div class="main-1-left back">
                            ...
                            <table class="table-tkb">
                            	<tr style='background:<?php echo $mauall; ?>;text-transform:uppercase;'>
                                    <th><span>Tổng cộng</span></th>
                                    <th><span>-<?php echo format_money_vnd(get_phat_hs($hsID)); ?></span></th>
                                </tr>
                            	<tr style='background:<?php echo $mauall; ?>;text-transform:uppercase;'>
                                    <th style="width:70%;"><span class="fa fa-align-left"></span></th>
                                    <th style="width:25%;"><span class="fa fa-money"></span></th>
                                ...
                                <?php
                                    ...
                                    while($data=mysqli_fetch_assoc($result)) {
                                        ...
                                        $total2=$total2+$data["price"];
                                    }
                                ?>
                                <tr style="background:<?php echo $mauall; ?>">
                                	<th colspan="2"><a href="http://localhost/www/TDUONG/mobile/tai-khoan-phat/"><span>Xem tất cả</span></a></th>
                                </tr>
                            </table>
                      	</div>
                    </div>
