                	...
                	<ul>
                    	<li id="chart-li1">
                            ...
                            <ul style="margin-top:3px;" id="msg-succ">
                                <li>
                                    <div style="width:100%;margin-top:0;text-align:center;"><p>- Bạn phải có ít nhất 50k trong tài khoản -</p></div>
                                </li>
                                <li>
                                    <div style="width:100%;margin-top:0;text-align:center;"><p>- Nếu không làm đủ số câu trong 1 tuần, bạn sẽ bị khóa chức năng Trắc nghiệmn -</p></div>
                                </li>
<!--                                <li>-->
<!--                                    <div style="width:100%;margin-top:0;text-align:center;"><p>- Mỗi bạn chỉ được thi 1 lần trong 1 ngày -</p></div>-->
<!--                                </li>-->
<!--                                <li>-->
<!--                                    <div style="width:100%;margin-top:0;text-align:center;"><p>- Khi đã vào thi, nếu có gián đoạn, kết quả sẽ không được công nhận -</p></div>-->
<!--                                </li>-->
                                <li>
                                    <div style="width:100%;margin-top:0;text-align:center;"><p>!!! Chúc các bạn làm bài tốt !!!</p></div>
                                </li>
                            </ul>
                        </li>
