...
?>
    ...
    <div class="popup animated bounceIn" id="popup-anh" style="width: 80%;left: 5%;top: 15%;">
        <div class="popup-close"><i class="fa fa-close"></i></div>
        <div style="position: relative;">
            ...
            <i class="fa fa-angle-left btn-img-left" style="position: absolute;left: -15px;top:0;font-size: 30px;"></i>
            <i class="fa fa-angle-right btn-img-right" style="position: absolute;right: -15px;top:0;font-size: 30px;"></i>
    ...
    <div class="popup animated bounceIn" id="popup-anh-done" style="width: 80%;left: 5%;top: 15%;">
        <div class="popup-close"><i class="fa fa-close"></i></div>
        <div style="position: relative;">
            <div style="max-height:400px;overflow: auto;">
                <div>
    ...
    <div id="SIDEBACK"><div id="BODY">
        ...
        <div id="MAIN">
            ...
            <div class="main-div back animated bounceInUp" id="main-top">
                <div id="main-person">
                  <h1>Phát vé ngày <?php echo format_dateup($date); ?></h1>
                    <div class="clear"></div>
                </div>
                <div id="main-avata">
            ...
            <?php
                ...
                if(isset($_POST["done-co"])) {
                    if(isset($_POST["done-ca1"]) && isset($_POST["done-ca2"]) && isset($_POST["done-ca3"])) {
                        ...
                        header("location:https://localhost/www/TDUONG/mobile/phat-ve/$date/");
//                        header("location:http://localhost/www/TDUONG/mobile/them-phat-ve/$sttID/$date/");
                        exit();
                    } else {
                        ...
                        if (isset($_POST["name"]) && isset($_POST["class"]) && isset($_POST["school2"])) {
                            ...
                            if ($check) {
                                ...
                                if ($check2) {
                                    ...
                                    //                                                }
                                    //                                                header("location:http://localhost/www/TDUONG/mobile/them-phat-ve/$sttID/");
                                    //                                                exit();
                                    //
                                    //                                            } else {
...
//                                                header("location:http://localhost/www/TDUONG/mobile/them-phat-ve/$sttID/$date/");
            ...
            <form action="http://localhost/www/TDUONG/mobile/them-phat-ve/<?php echo $sttID; ?>/<?php echo $date; ?>/" method="post" enctype="multipart/form-data">
                    ...
                    <ul>
                        <li id="chart-li1">
                            ...
                            <ul style="margin-top:3px;">
                                ...
                                <li>
                                    <div><p>ID vé</p></div>
                                    <div style="width:58%;"><input type="number" name="the" id="the" value="<?php echo $data3["the"] ?>" placeholder="Mã vẽ" autocomplete="off" style="width:90%;padding:5%" class="input" /></div>
                                </li>
                                <li>
                                    <div><p>Họ và tên</p></div>
                                    <div style="width:58%;"><input type="text" name="name" id="name" placeholder="Họ tên" value="<?php echo $data3["name"]; ?>" autocomplete="off" style="width:90%;padding:5%" class="input" /></div>
                                </li>
                                <li>
                                    <div><p>Trường</p></div>
                                    <div style="width:58%;"><input type="text" name="school" id="add-truong" value="<?php echo $data3["truong_name"]; ?>" data-truong="<?php echo $data3["school"] ?>" placeholder="Trường" autocomplete="off" style="width:90%;padding:5%" class="input" /><input type="hidden" name="school2" id="add-truong2" value="<?php echo $data3["school"] ?>" data-truong="0"/></div>
                                    <nav id="search-truong" class="search-div2" style="float: right;top:auto;margin-top:2px;width: 60%;display: none;">
                                        <ul>
                                        </ul>
                                    </nav>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div style="width:58%;"><input type="number" name="number" id="number" value="<?php echo $data3["sdt"] ?>" placeholder="Số điện thoại" autocomplete="off" style="width:90%;padding:5%" class="input" /></div>
                                </li>
                                <li>
                                    <div><p>SĐT phụ huynh</p></div>
                                    <div style="width:58%;"><input type="number" name="number-parent" id="number-parent" value="<?php echo $data3["sdt_phuhuynh"] ?>" placeholder="Số điện thoại phụ huynh" autocomplete="off" style="width:90%;padding:5%" class="input" /></div>
                                </li>
                                <li>
                                    <div><p>Link facebook</p></div>
                                    <div style="width:58%;"><input type="text" name="link-fb" id="link-fb" value="<?php echo $data3["facebook"] ?>" placeholder="Link facebook" autocomplete="off" style="width:90%;padding:5%" class="input" /></div>
                                </li>
    <!--                                    <li>-->
    <!--                                        <div style="width:100%;">-->
    ...
    <!--                                    </li>-->
                                <li>
                                    <div><p>Quá trình mời</p></div>
                                    <div style="width:58%;">
                                        <input type="file" name="fileToUpload-image[]" multiple="multiple" style="width: 40%;" class="submit" id="fileToUpload"/>
                                        <?php if($sttID!=0) { ?>
