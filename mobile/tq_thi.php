...
//                                        location.reload();
			...
			<?php } ?>
                ...
                $("#DOCK ul").append("<li style='width: 100%;'><a href='http://localhost/www/TDUONG/mobile/xin-nghi-hoc/'>Xin nghỉ kiểm tra có phép</a></li>");
			});
		</script>
                ...
                <div class="main-div animated bounceInUp">
                    <div id="main-info">
                        <div class="main-1-left back">
                            <div>
                                <h1 style="margin-bottom: 5px;">Lịch thi</h1>
                                    ...
                                    <td style='padding-top: 0;padding-bottom: 0;'>
                                        <ul class='ul-ca'>
                                            ...
                                            while($data4=mysqli_fetch_assoc($result4)) {
                                                ...
                                                echo "<span>$buoi<br />$data4[gio]</li>";
                                            }
                                            ?>
                                        </ul>
                                    </td>
                                    <td style='width: 50%;padding-top: 0;padding-bottom: 0;'><div id='chart-codinh-0' style='width:100%;height:<?php echo 55.5*count($cum_arr[0]); ?>px;'></div></td>
                                </tr>
                            </table>
