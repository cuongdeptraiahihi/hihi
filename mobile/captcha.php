...
class SimpleCaptcha {
    ...
    public $fonts = array(
		...
		//'Hevetica'    => array('spacing' => 6, 'minSize' => 28, 'maxSize' => 34, 'font' => 'HelveticaNeue-Thin.ttf'),
        'VeraSans' => array('spacing' => 6, 'minSize' => 20, 'maxSize' => 28, 'font' => 'VeraSansBold.ttf'),
    );
    ...
    protected function WriteText($text, $fontcfg = array()) {
        ...
        for ($i=0; $i<$length; $i++) {
            ...
            $letter   = mb_strtoupper(substr($text, $i, 1));
            ...
            $x += ($coords[2]-$x) + ($fontcfg['spacing']*$this->scale*$fontSizefactor);
        }
