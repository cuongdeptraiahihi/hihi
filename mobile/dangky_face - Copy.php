...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        $face=NULL;
        $me=false;
        if(isset($_POST["face-ok"])) {
            if(isset($_POST["face-in"])) {
                $face=$_POST["face-in"];
            }
            if($face && $face!="" && $face!=" " && $face!="_" && valid_text($face)) {
                add_dangky_face($hsID,$face,$lmID);
                echo"<div class='popup animated bounceIn' style='display: block;'>
                        <p>Link facebook và yêu cầu của bạn đã được gửi đến Admin! Vui lòng làm tiếp bước 2!</p>
                    </div>";
                $me=true;
            } else {
                echo"<div class='popup animated bounceIn' style='display: block;'>
                        <p>Dữ liệu không chính xác!</p>
                    </div>";
                $me=false;
            }
        }
      	...
      	<div id="SIDEBACK"><div id="BODY">
            ...
            <div id="MAIN">
                ...
                <div class="main-div animated bounceInUp">
                	<ul>
                    	<li id="chart-li1">
                        	<div class="main-2 back"><h3>Bước 1</h3></div>
                            <ul style="margin-top:3px;" id="msg-succ">
                                <?php
                                if($me) {
                                    echo"<li><div style='width:100%;margin-top:0;text-align:center;'><p>Link facebook và yêu cầu của bạn đã được gửi đến admin! Vui lòng làm tiếp bước 2!</p></div></li>";
                                } else {
                                    ?>
                                    <form action="http://localhost/www/TDUONG/mobile/dang-ky-facebook/" method="post">
                                        <li>
                                            <div style="width:100%;margin-top:0;text-align:center;"><p>Copy link facebook cá nhân của các bạn vào đây!</p></div>
                                        </li>
                                        <li>
                                            <div style="width:72%;"><input type="text" style="padding:4%;" placeholder="Link trang cá nhân" name="face-in" id="face-in" class="input" /></div>
                                            <div style="width:25%;text-align:center;"><input type="submit" class="submit" value="Đăng ký" name="face-ok" id="face-ok" /></div>
                                        </li>
                                        <li>
                                            <div style="width:100%;margin-top:0;text-align:center;"><img src="https://localhost/www/TDUONG/images/face.png" style="width: 100%;height: auto;" /></div>
                                        </li>
                                    </form>
                                <?php } ?>
                            </ul>
                        </li>
                        <li id="chart-li1" style="margin-top:15px;">
                        	<div class="main-2 back"><h3>Bước 2</h3></div>
                            <ul style="margin-top:3px;">
                                <li onclick="location.href='<?php echo get_facebook($lmID); ?>'" style="cursor:pointer;">
                                    <div style="width:100%;margin-top:0;text-align:center;"><p>Nhấn vào đây để vào >> Group <a href="<?php echo get_facebook($lmID); ?>" class="fa fa-facebook-official" style="font-size:14px;color:#FFF;"></a> << và sau đó chọn Tham gia nhóm</p></div>
                                </li>
                            </ul>
                        </li>
                    </ul>
