    ...
    <div id="SIDEBACK"><div id="BODY">
        ...
        <div id="MAIN">
            ...
            <div class="main-div animated bounceInUp">
                <ul>
                    <li id="chart-li1">
                        <div class="main-2 back" style="text-align:left;background: none;padding: 0;"><button class="submit" onclick="location.href='http://localhost/www/TDUONG/mobile/them-phat-ve/0/<?php echo $date; ?>/'"><i class="fa fa-plus"></i> Thêm bạn mới</button></div>
                    </li>
                </ul>
                <div class="clear"></div>
            </div>
            ...
            <div class="main-div animated bounceInUp">
                ...
                <div id="main-table" class="main1-table">
                    <table class="table">
                        ...
                        while($data6=mysqli_fetch_assoc($result6)) {
                            ...
                            if(strlen($data6["the"])<1) {
                                ...
                                if($data6["ID_HS"]==$hsID && $check=="on") {
                                    echo"<td><button type='button' class='view submit' onclick=\"location.href='http://localhost/www/TDUONG/mobile/them-phat-ve/$data6[ID_STT]/$date/'\">Xem</button> <button class='del submit'>Xóa</button></td>";
                                } else {
                                    echo"<td><button type='button' class='view submit' onclick=\"location . href = 'http://localhost/www/TDUONG/mobile/them-phat-ve/$data6[ID_STT]/$date/'\">Xem</button></td>";
                                }
                            echo"</tr>";
                            $stt++;
                        }
                        if($stt==1) {
                            echo "<tr data-id='$data6[ID_STT]' class='tr-me back tr-fixed stt'>
                                <td colspan='6'><span>Hiện nhóm bạn chưa mời dược ai!</span></td>
                            </tr>";
                        }
                        ?>
                    </table>
