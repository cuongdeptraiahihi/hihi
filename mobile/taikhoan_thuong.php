					...
					<div class="page-number back">
						...
						<?php
							if($current!=1) {
								...
								echo"<li><a href='http://localhost/www/TDUONG/mobile/tai-khoan-thuong/page-$prev/'><</a></li>";
							}
							for($page=1;$page<=$sum_page;$page++) {
								$begin=($page-1)*$display;
								if($page==$current) {
									echo"<li style='background:rgba(0,0,0,0.35);'><a href='http://localhost/www/TDUONG/mobile/tai-khoan-thuong/page-$begin/' style='font-weight:600;'>$page</a></li>";
								} else {
									echo"<li><a href='http://localhost/www/TDUONG/mobile/tai-khoan-thuong/page-$begin/'>$page</a></li>";
								}
							}
							if($current!=$sum_page) {
								$next=$position+$display;
								echo"<li><a href='http://localhost/www/TDUONG/mobile/tai-khoan-thuong/page-$next/'>></a></li>";
							}
						?>
						</ul>
					</div>
