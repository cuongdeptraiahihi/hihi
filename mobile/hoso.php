            ...
            <div id="MAIN">
            	...
            	<div class="main-div back animated bounceInUp" id="main-top">
                    <div id="main-person">
                        ...
                        <?php
                        $lich_hoc=get_hs_lich_hoc3($hsID,$lmID,$monID);
                        $lich_thi=get_hs_lich_thi($hsID,$monID);
                        $lich_tc=get_hs_tang_cuong($hsID,$lmID,$monID);
                        echo"<p style='margin-bottom:5px;margin-top:5px;width:100%;float: none;'><a href='http://localhost/www/TDUONG/mobile/lich-hoc/' style='font-weight:600;font-size:12px;color:#FFF;'>Lịch học cố định:</a><br />$lich_hoc</p>
                        	<p style='float: none;'><a href='http://localhost/www/TDUONG/mobile/lich-thi/' style='font-weight:600;font-size:12px;color:#FFF;'>Lịch thi:</a><br />$lich_thi</p>";
                        if($lich_tc!="") {
                            echo"<p style='float: none;'><a href='http://localhost/www/TDUONG/mobile/lich-hoc/' style='font-weight:600;font-size:12px;color:#FFF;'>Lịch tăng cường:</a><br />$lich_tc</p>";
                        }
                        ?>
                        <div class="clear"></div>
                    </div>
                ...
                <div class="main-div animated bounceInUp">
                	<ul>
                    	<li id="chart-li1" class="li-3">
                            ...
                            <ul style="margin-top:3px;">
                                ...
                                <li style="padding: 10px;">
                                    ...
                                    <div style="width:58%;"><a href="<?php echo $face; ?>" style="color:#FFF;font-size:12px;text-decoration:underline;">Link</a></div>
                                </li>
                                <li style="padding: 10px;">
                                    <div><p>LEVEL</p></div>
                                    <div style="width:58%;"><a href="javascript:void(0)" style="color:#FFF;font-size:12px;"><?php echo $data0["level"]; ?></a></div>
                                </li>
                        ...
                        <li id="chart-li1" class="li-3" style="margin-top: 3px">
                            ...
                            <ul style="margin-top:3px;">
                            	<form action="http://localhost/www/TDUONG/mobile/ho-so/" method="post">
                                    <li>
				    ...
				    <li>
                        ...
                        <!--<li id="main-tb" class="li-3" style="margin-top: 3px">
                            ...
                            <ul style="margin-top:3px;">
                            <form action="http://localhost/www/TDUONG/mobile/ho-so/" method="post" enctype="multipart/form-data">
                            	<li><div style="width:100%;text-align:center;"><p>Hãy chọn 1 ảnh vuông (.png, .jpg, .gif)</p></div></li>
                                <li style="padding-top:5px;padding-bottom:5px;"><input type="file" class="submit" name="avata" id="avata" /></li>
