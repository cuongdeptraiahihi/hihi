      	...
      	<div id="SIDEBACK"><div id="BODY">
            ...
            <div id="MAIN">
                ...
                <div class="main-div hideme animated bounceInUp">
                	<div class="main-1 back"><h3>Biểu đồ theo dõi số buổi đi học,<br /> nghỉ học trong 24 tháng</h3></div>
                    <div id="main-chart2">
                    	<div id="chartContainer2" class="clear" style="height:295px;margin-left:-25px;"></div>
                    </div>
                    <div class="clear"></div>
                </div>
