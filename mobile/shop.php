                    ...
                    if(confirm("Bạn có chắc chắn không?")) {
                        if (id != "") {
                            ...
                            $.ajax({
                                ...
                                data: "sach_xoa=" + id,
                                type: "post",
                                url: "http://localhost/www/TDUONG/mobile/xuly-tailieu/",
                ...
                <div class="main-div animated bounceInUp">
                    <?php
                        ...
                        while($data=mysqli_fetch_assoc($result)) {
                            ...
                            echo"<li id='chart-li1' class='li-3'>
                                <ul>
                                    <li>
                                        <div class='div-dad'>";
                                            ...
                                            echo"<form action='http://localhost/www/TDUONG/mobile/shop-mua/' method='post'>
