...
//                    }, time_anim);
                ...
                $("#btn-done").click(function () {
                    window.location.href="http://localhost/www/TDUONG/mobile/mon/";
                });
...
//                        var code = response.code;
                        ...
                        var sdt_me = $("#add-sdt-me").val().trim();
                        var truong = $("#add-truong").attr("data-truong");
                        if(code != "" && name != "" && (name_bo != "" || name_me != "") && (gender == 1 || gender == 0) && birth != "" && $.isNumeric(sdt) && ($.isNumeric(sdt_bo) || $.isNumeric(sdt_me)) && $.isNumeric(truong)) {
                        ...
                        <li id="chart-li1"  class="li-content" style="display: none;">
                            ...
                            <ul style="margin-top:3px;">
                                ...
                                <li>
                                    ...
                                    <div style="width:58%;">
                                        <select class="input" style="width:95%;" id="add-gender">
                                ...
                                <li>
                                    ...
                                    <div style="width:58%;position: relative;">
                                        ...
                                        <select class="input" style="width: 95%;" id="add-truong-suggest">
                                        </select>
                                    </div>
                                </li>
                                <li>
                            ...
                            <ul style="margin-top:3px;">
                                ...
                                <li>
                                    <div style="width:100%;">
                                        ...
                                        <div style="text-align: center;"><div style="margin-top: 10px;" class="fb-page" data-href="https://www.facebook.com/Bgo.edu.vn/" data-tabs="messages" data-height="250" data-small-header="true" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"></div></div>
                                    </div>
                                </li>
                                <li>
