        ...
        <div id="MAIN">
            ...
            <div class="main-div back animated bounceInUp" id="main-top">
                <div id="main-person">
                    ...
                    $price += 2000000;
                    echo"<h1 style='line-height:98px;'>KHO BÁU: ".format_price($price)."</h1>";
                    ?>
                    <div class="clear"></div>
                </div>
                <div id="main-avata">
            ...
            <?php
                ...
                if(isset($_POST["delete"]) && ($check_game || $dubi)) {
                    ...
                    if($data1["ID_HS"]==$hsID && $level==1) {
                        ...
                        header("location:https://localhost/www/TDUONG/game/");
                        exit();
                    }
                }
                ...
                <ul>
                    ...
                    <li id="chart-li1" class="li-3">
                        ...
                        <ul style="margin-top:3px;">
                            <form action="https://localhost/www/TDUONG/game/" method="post">
                                <li>
                    ...
                    <li id="chart-li1" class="li-3">
                        <ul style="margin-top:3px;">
                            <?php if(!$check_game) { ?>
                            <li>
                                <div style="width:100%;margin-top:0;text-align:center;"><p style="line-height: 24px;">DANH SÁCH ĐÃ ĐƯỢC CHỐT, BẠN KHÔNG THỂ RỜI HAY XÓA NHÓM TRỪ KHI BẠN LÀ NHÓM DỰ BỊ</p></div>
                            </li>
                            <?php } ?>
                            <li>
                                <div style="width:100%;margin-top:0;text-align: center;"><img src="https://localhost/www/TDUONG/images/mission.png" style="width: 80%;" /></div>
                            </li>
                        </ul>
                    </li>
                    <?php } else { ?>
