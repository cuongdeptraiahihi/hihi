      	...
      	<div id="BODY">
            ...
            <div id="MAIN">
              	...
              	<div class="main-div back animated bounceInUp" id="main-top">
                	<div id="main-person">
                		<h1 style="line-height:98px;">Lịch sử cộng tiền</h1>
                        <div class="clear"></div>
                   	</div>
                    <div id="main-avata">
                ...
                <div class="main-div animated bounceInUp">
                	<div class="main-1 back" style="border-bottom:none;border-bottom-left-radius:0;border-bottom-right-radius:0;"><h3>Tổng cộng: +<?php echo format_price(get_thuong_hs($hsID)); ?></h3></div>
                    <div id="main-table">
                    	<table>
                        	<tr id="table-head" class="back tr-big">
                            	<th style="width:10%;"><span>STT</span></th>
                                <th style="width:15%;"><span>Ngày</span></th>
                                <th style="width:55%;"><span>Nội dung</span></th>
                            ...
                            <?php
								...
								$stt=1;$display=30;
								$result=get_thuong_hocsinh_sort($hsID,$position,$display);
                    ...
                    <?php
						$result2=get_thuong_hocsinh($hsID);
					...
					<div class="page-number back">
						...
						<?php
							if($current!=1) {
								...
								echo"<li><a href='https://localhost/www/TDUONG/tai-khoan-thuong/page-$prev/'><</a></li>";
							}
							for($page=1;$page<=$sum_page;$page++) {
								$begin=($page-1)*$display;
								if($page==$current) {
									echo"<li style='background:rgba(0,0,0,0.35);'><a href='https://localhost/www/TDUONG/tai-khoan-thuong/page-$begin/' style='font-weight:600;'>$page</a></li>";
								} else {
									echo"<li><a href='https://localhost/www/TDUONG/tai-khoan-thuong/page-$begin/'>$page</a></li>";
								}
							}
							if($current!=$sum_page) {
								$next=$position+$display;
								echo"<li><a href='https://localhost/www/TDUONG/tai-khoan-thuong/page-$next/'>></a></li>";
							}
						?>
						</ul>
					</div>
