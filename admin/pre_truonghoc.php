            ...
            <div id="MAIN">
                ...
                <?php
					...
					if(isset($_GET["xem"])) {
						...
						if($tp && $quan) {
							header("location:http://localhost/www/TDUONG/admin/truong-hoc/$tp/$quan/");
							exit();
						}
					}
					if(isset($_GET["xem-all"])) {
						header("location:http://localhost/www/TDUONG/admin/truong-hoc/");
						exit();
					}
				?>
                ...
                <div id="main-mid">
                	...
                	<div>
                    	<div class="status">
                        	<form action="http://localhost/www/TDUONG/admin/pre-truong-hoc/" method="get">
                        		<table class="table">
                                    <tr>
