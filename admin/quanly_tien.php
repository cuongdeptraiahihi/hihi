                    	...
                    	<div class="status">	
                            	<table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td><input class='submit' type='submit' value='Xem' onclick="location.href='http://localhost/www/TDUONG/admin/hoc-sinh-tien-hoc/'" /></td>
...
<!--                                        <td><input class='submit' type='submit' value='Xem' onclick="location.href='http://localhost/www/TDUONG/admin/tai-khoan/--><?php //echo $lmID; ?>///'" /></td>
...
<!--//                                    </tr>-->
                                    <tr>
                                        ...
                                        <td><input class='submit' type='submit' value='Xuất Excel (lâu)' onclick="location.href='http://localhost/www/TDUONG/admin/kiem-tra-tien-hoc-mon/<?php echo $lmID; ?>/1/'" /></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input class='submit' type='submit' value='Kiểm tra' onclick="location.href='http://localhost/www/TDUONG/admin/kiem-tra-tien/'" /></td>
...
<!--                                        <td><input class='submit' type='submit' value='Tìm' onclick="location.href='http://localhost/www/TDUONG/admin/tien-search/'" /></td>-->
