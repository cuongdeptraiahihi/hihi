            ...
            <div id="MAIN">
            	...
            	<div id="main-left">
                    <div>
                    	<h3>Menu</h3>
                        <ul>
                            <li class="action"><a href="http://localhost/www/TDUONG/admin/tinh-tp/"><i class="fa fa-map"></i>Tỉnh/Thành phố</a></li>
							<li class="action"><a href="http://localhost/www/TDUONG/admin/pre-quan-huyen/"><i class="fa fa-map-pin"></i>Quận/Huyện</a></li>
                            <li class="action"><a href="http://localhost/www/TDUONG/admin/pre-truong-hoc/"><i class="fa fa-university"></i>Trường cấp 3</a></li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="page-number">
                            ...
                            <?php
								if($current!=1) {
									...
									echo"<li><a href='http://localhost/www/TDUONG/admin/quan-huyen/$tpID/page-$prev/'><</a></li>";
								}
								for($page=1;$page<=$sum_page;$page++) {
									$begin=($page-1)*$display;
									if($page==$current) {
										echo"<li><a href='http://localhost/www/TDUONG/admin/quan-huyen/$tpID/page-$begin/' style='font-weight:bold;text-decoration:underline;'>$page</a></li>";
									} else {
										echo"<li><a href='http://localhost/www/TDUONG/admin/quan-huyen/$tpID/page-$begin/'>$page</a></li>";
									}
								}
								if($current!=$sum_page) {
									$next=$position+$display;
									echo"<li><a href='http://localhost/www/TDUONG/admin/quan-huyen/$tpID/page-$next/'>></a></li>";
								}
							?>
                            </ul>
                        </div>
                	...
                	<div>
                        ...
                        <?php
							...
							while($data2=mysqli_fetch_assoc($result2)) {
								echo"<li><a href='http://localhost/www/TDUONG/admin/quan-huyen/$data2[ID_TP]/' ";if($data2["ID_TP"]==$tpID){echo"style='font-weight:600'";}echo">$data2[ID_TP]. $data2[thanhpho]</a></li>";
							}
						?>
                        </ul>
                  	</div>
