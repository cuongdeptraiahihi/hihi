...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>       
        ...
        <link rel="stylesheet" type="text/css" href="http://hehe.bgo.edu.vn/css/bocuc.css"/>
        <link href="http://hehe.bgo.edu.vn/images/favicon.ico" rel="shortcut icon" type="iamge/x-icon"/>
        <link rel="stylesheet" href="http://hehe.bgo.edu.vn/css/font-awesome.min.css">
    ...
    <body>
    	...
    	<div class="popup" id="popup-loading">
      		<p><img src="http://hehe.bgo.edu.vn/images/ajax-loader.gif" /></p>
      	</div>
...
//                            mysqli_query($db, $query2);
                ...
                <div id="main-mid">
                	...
                	<div>
                    	<div class="status">
                        	<form action="http://hehe.bgo.edu.vn/nhapdiem3.php" method="post" enctype="multipart/form-data">
                        		<table class="table">
                                    <tr>
