      	...
      	<div id="BODY">
            ...
            <div id="MAIN">
                	...
                	<div>
                    	<div class="status">	
                            <table class="table">
                            	<tr>
                                    <td colspan="2"></td>
                                	<td><input type='submit' class='submit' onclick="location.href='http://localhost/www/TDUONG/admin/danh-muc/<?php echo $lmID."/".$monID; ?>/'" value='Danh mục ngoài chuyên đề' /></td>
                                    <td colspan="2"><input type='submit' class='submit' onclick="location.href='http://localhost/www/TDUONG/admin/chuyen-de/<?php echo $lmID; ?>/'" value='Danh sách các chuyên đề' /></td>
                                </tr>
                                ...
                                <?php
									...
									while($data1=mysqli_fetch_assoc($result1)) {
										echo"<tr>
											...
											<td><input type='submit' class='submit' onclick=\"location.href='http://localhost/www/TDUONG/admin/tai-lieu-chuyen-de/$data1[ID_CD]/'\" value='Xem' /></td>
                                        </tr>";
									}
                                    ...
                                    while($data1=mysqli_fetch_assoc($result1)) {
                                        echo"<tr>
											...
											<td><input type='submit' class='submit' onclick=\"location.href='http://localhost/www/TDUONG/admin/tai-lieu-chuyen-de/$data1[ID_DM]/'\" value='Xem' /></td>
                                        </tr>";
                                    }
								?>
                            </table>
                ...
                <?php } ?>
                                <tr>
                                    <td colspan="5"></td>
                                    <td><input type='submit' class='submit' onclick="location.href='http://localhost/www/TDUONG/admin/danh-muc/<?php echo $lmID."/".$monID; ?>/'" value='Danh mục' /></td>
                                    <td><input type='submit' class='submit' onclick="location.href='http://localhost/www/TDUONG/admin/up-tai-lieu/<?php echo $lmID."/".$monID; ?>/'" value='Thêm tài liệu' /></td>
                                </tr>
                                <tr style="background:#3E606F;">
...
//                                <td><span>".count_tailieu_like($data2["ID_TL"])." / ".count_tailieu_cmt($data2["ID_TL"])."</span></td>
									while($data2=mysqli_fetch_assoc($result2)) {
										...
										echo"<tr>
											...
											<td>
                                            	<input type='submit' class='submit' onclick=\"location.href='http://localhost/www/TDUONG/admin/xem-tai-lieu/$data2[ID_TL]/'\" value='Xem' />
												<input type='submit' class='submit' onclick=\"location.href='http://localhost/www/TDUONG/admin/sua-tai-lieu/$data2[ID_TL]/'\" value='Sửa' />
                        ...
                        <div class="page-number">
                            ...
                            <?php
								if($current!=1) {
									...
									echo"<li><a href='http://localhost/www/TDUONG/admin/tai-lieu/$lmID/$monID/page-$prev/'><</a></li>";
								}
								for($page=1;$page<=$sum_page;$page++) {
									$begin=($page-1)*$display;
									if($page==$current) {
										echo"<li><a href='http://localhost/www/TDUONG/admin/tai-lieu/$lmID/$monID/page-$begin/' style='font-weight:bold;text-decoration:underline;'>$page</a></li>";
									} else {
										echo"<li><a href='http://localhost/www/TDUONG/admin/tai-lieu/$lmID/$monID/page-$begin/'>$page</a></li>";
									}
								}
								if($current!=$sum_page) {
									$next=$position+$display;
									echo"<li><a href='http://localhost/www/TDUONG/admin/tai-lieu/$lmID/$monID/page-$next/'>></a></li>";
								}
							?>
                            </ul>
                        </div>
