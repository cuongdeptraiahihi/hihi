                ...
                if(isset($_POST["search-ok"])) {
                    ...
                    if(valid_maso($maso)) {
                        ...
                        if(is_numeric($id) && $id!=0) {
                            header("location:http://localhost/www/TDUONG/admin/level-thuong/$id/");
                            exit();
                        } else {
                            header("location:http://localhost/www/TDUONG/admin/level-thuong/");
                            exit();
                        }
                    } else {
                        header("location:http://localhost/www/TDUONG/admin/level-thuong/");
                ...
                <div id="main-mid">
                	...
                	<div>
                    	<div class="status">
                            <table class="table">
                                <tr>
                                    <form action="http://localhost/www/TDUONG/admin/level-thuong/" method="post">
