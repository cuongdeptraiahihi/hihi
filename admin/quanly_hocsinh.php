                    	...
                    	<div class="status">	
                            	<table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td><input class='submit' type='submit' value='Xem' onclick="location.href='http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin/<?php echo $_SESSION["lmID"]."/".$_SESSION["mon"]; ?>/'" /></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input class='submit' type='submit' value='Xem' onclick="location.href='http://localhost/www/TDUONG/admin/hoc-sinh-diem-danh/<?php echo $_SESSION["lmID"]."/".$_SESSION["mon"]; ?>/1/'" /></td>
...
<!--                                        <td><input class='submit' type='submit' value='Xem' onclick="location.href='http://localhost/www/TDUONG/admin/level-thuong/'" /></td>-->
...
<!--                                        <td><input class='submit' type='submit' value='Xem' onclick="location.href='http://localhost/www/TDUONG/admin/truy-cap/'" /></td>-->
...
<!--                                    </tr>-->
                                    ...
                                    <!--<tr>
                                        ...
                                        <td><span>Log</span></td>
                                        <td><input class='submit' type='submit' value='Xem' onclick="location.href='http://localhost/www/TDUONG/admin/xem-log/'" /></td>
