                    	...
                    	<div class="status">	
                            	<table class="table">
                                    ...
                                    <!--<tr>
                                        ...
                                        <td><input class='submit' type='submit' value='Cài đặt' onclick="location.href='http://localhost/www/TDUONG/admin/videos/'" /></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input class='submit' type='submit' value='Mở' onclick="location.href='http://localhost/www/TDUONG/admin/mo-video-hoc-sinh/'" /></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input class='submit' type='submit' value='Mở' onclick="location.href='http://localhost/www/TDUONG/admin/pre-mo-video-hang-loat/'" /></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input class='submit' type='submit' value='Mở' onclick="location.href='http://localhost/www/TDUONG/admin/pre-tai-lieu/'" /></td>
