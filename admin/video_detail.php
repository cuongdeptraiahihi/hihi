            	...
            	<div id="main-left">
                    ...
                    <div>
                        ...
                        <ul>
                        	...
                        	<li class="action"><a href="http://localhost/www/TDUONG/admin/sua-video/<?php echo $videoID;?>/"><i class="fa fa-edit"></i>Sửa video</a></li>
                ...
                <div id="main-mid">
                	...
                	<div>
                        ...
                        <div class="status list-more">
							...
							?>
                            	<li><a href="http://localhost/www/TDUONG/admin/video/<?php echo $data0["ID_VIDEO"]; ?>/">+ <?php echo $data0["title"]; ?><?php if($data0["ID_VIDEO"]==$videoID) {echo"<span>Đang xem</span>";} ?></a></li>
							<?php	
                                }
							?>
                            </ul>
