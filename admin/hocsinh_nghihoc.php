                            ...
                            <table class="table" id="list-nghihoc">
                                <tr>
                                    <td style="border: none;" colspan="5">
                                        <form action="http://localhost/www/TDUONG/admin/hoc-sinh-nghi-hoc/<?php echo $cumID; ?>/<?php echo $lmID; ?>/<?php echo $lmID2; ?>/<?php echo $loai; ?>/" method="post">
                                            <?php
                                            ...
                                            ?>
                                            <input class='submit' type='button' onclick="location.href='http://localhost/www/TDUONG/admin/hoc-sinh-nghi-hoc/<?php echo $cumID; ?>/<?php echo $lmID; ?>/<?php echo $lmID2; ?>/4/'" value='Lọc đã nhắn tin' />
                                            <input class='submit' type='button' onclick="location.href='http://localhost/www/TDUONG/admin/hoc-sinh-nghi-hoc/<?php echo $cumID; ?>/<?php echo $lmID; ?>/<?php echo $lmID2; ?>/5/'" value='Lọc đã xác nhận' />
                                        </form>
                                    </td>
                                </tr>
<!--                                --><?php
...
//									    add_hs_note_only($data2["ID_HS"],$ngay,"",0,$lmID);
										...
										echo"<th style='background: #3E606F;' class='hidden'><span>".($dem+1)."</span></th>
											<th style='background: #EF5350;position:relative;'>
											    <span><a href='".formatFacebook($data2["facebook"])."' target='_blank'>$data2[fullname]</a><br /><a href='http://localhost/www/TDUONG/admin/hoc-sinh-chi-tiet/ma/$data2[cmt]/' target='_blank'>($data2[cmt])</a><br />".get_hs_lich_hoc($data2["ID_HS"],$lmID,$monID)."</span>";
...
<?php
    if($is_bao) {
        ...
        header("location:http://localhost/www/TDUONG/admin/hoc-sinh-nghi-hoc/$cumID/$lmID/$lmID2/$loai/");
        exit();
    }
	ob_end_flush();
