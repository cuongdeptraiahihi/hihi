                        ...
                        <div class="status">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td><input class='submit' type='submit' value='Thêm' onclick="location.href='http://localhost/www/TDUONG/admin/nhap-diem/'" /></td>
                                ...
                                <tr>
                                    ...
                                    <td><input class='submit' type='submit' value='Thêm' onclick="location.href='http://localhost/www/TDUONG/admin/nhap-diem2/'" /></td>
                                ...
                                <tr>
                                    ...
                                    <td><input class='submit' type='submit' value='Thêm' onclick="location.href='http://localhost/www/TDUONG/admin/nhap-diem4/'" /></td>
                                    <td class="hidden"><span>Chỉ nhập tổng điểm từ file excel</span></td>
                                </tr>
                                <tr>
                                    <td class="hidden"><span>4</span></td>
                                    <td><span class="fa fa-download"></span></td>
                                    <td><span>Nhập điểm từ file Excel</span></td>
                                    <td><input class='submit' type='submit' value='Nhập' onclick="location.href='http://localhost/www/TDUONG/admin/nhap-diem3/'" /></td>
                                    <td class="hidden"><span>Up file excel theo định dạng mẫu</span></td>
                                </tr>
                                <tr>
                                    <td class="hidden"><span>5</span></td>
                                    <td><span class="fa fa-level-up"></span></td>
                                    <td><span>Xét chuyển đề</span></td>
                                    <td><input class='submit' type='submit' value='Xét' onclick="location.href='http://localhost/www/TDUONG/admin/xet-nhay-de/'" /></td>
                                ...
                                <tr>
                                    ...
                                    <td><input class='submit' type='submit' value='Xem' onclick="location.href='http://localhost/www/TDUONG/admin/moi-chuyen-de/<?php echo $lmID; ?>/G/'" /></td>
                                ...
                                <tr>
                                    ...
                                    <td><input class='submit' type='submit' value='Xem' onclick="location.href='http://localhost/www/TDUONG/admin/hoc-sinh-huy-bai/'" /></td>
                                ...
                                <tr>
                                    ...
                                    <td><input class='submit' type='submit' value='Xem' onclick="location.href='http://localhost/www/TDUONG/admin/hoc-sinh-sai-nhieu/<?php echo $lmID; ?>/'" /></td>
