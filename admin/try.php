            ...
            <div id="MAIN">
                ...
                <?php
					...
					if(isset($_GET["xem"])) {
						...
						if($mon && $cd && $lop) {
							header("location:http://localhost/www/TDUONG/admin/mo-video-hang-loat/$mon/$lop/$cd/");
							exit();
						}
					}
				?>
                ...
                <div id="main-mid">
                	...
                	<div>
                    	<div class="status">
                        	<form action="http://localhost/www/TDUONG/admin/pre-mo-video-hang-loat/" method="get">
                        		<table class="table">
                                    <tr>
