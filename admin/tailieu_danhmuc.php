            ...
            <div id="MAIN">
            	...
            	<div id="main-left">
                    ...
                    <div>
                    	<h3>Menu</h3>
                        <ul>
                            <li class="action"><a href="http://localhost/www/TDUONG/admin/chuyen-de/<?php echo $lmID."/".$monID; ?>/"><i class="fa fa-newspaper-o"></i>CHUYÊN ĐỀ</a></li>
                            <?php
                	...
                	<div>
                    	<div class="status">	
                            <table class="table">
                                <tr>
                                    <td colspan="5"></td>
                                    <td><input type='submit' class='submit' onclick="location.href='http://localhost/www/TDUONG/admin/up-tai-lieu/<?php echo $data0["ID_MON"]; ?>/'" value='Thêm tài liệu' /></td>
                                </tr>
