      	...
      	<div id="BODY">
            ...
            <div id="MAIN">
                ...
                <div id="main-mid">
                	...
                	<div>
                    	<div class="status">
                        	<form action="http://localhost/www/TDUONG/admin/kiem-tra-diem-danh/<?php echo str_replace("/","-",$ngay); ?>/<?php echo $caID; ?>/<?php echo $lmID; ?>/<?php echo $monID; ?>/" method="post" enctype="multipart/form-data">
                        		<table class="table">
                                    <tr>
