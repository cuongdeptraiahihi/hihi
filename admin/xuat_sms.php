                    	...
                    	<div class="status">
                            <table class="table">
                                <tr>
                                    ...
                                    <td style="text-align: left;padding-left: 15px;" colspan="2"><a href="http://localhost/www/TDUONG/admin/sms/">Thông báo tiền học tháng <?php echo $thang_toi; ?> (Excel)</a></td>
                                </tr>
                                <tr>
                                    <td><span><i class="fa fa-newspaper-o"></i></span></td>
                                    <td style="text-align: left;padding-left: 15px;" colspan="2"><a href="http://localhost/www/TDUONG/admin/sms-tuy-chon/">Nội dung tùy chọn</a></td>
                                </tr>
                                <tr>
                                    <td><span><i class="fa fa-newspaper-o"></i></span></td>
                                    <td style="text-align: left;padding-left: 15px;" colspan="2"><a href="http://localhost/www/TDUONG/admin/sms-tu-dong/">SMS đơn lẻ</a></td>
                                </tr>
