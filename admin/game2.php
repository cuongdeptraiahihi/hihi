                                ...
                                dataPoints: [
                                    <?php
                                        ...
                                        for($i=0;$i<$n;$i++) {
                                            ...
                                            if($num==0) {$num=1;}
                                            echo "{ y: $num, orther: '$num', indexLabelFontColor: '#3E606F', color: '#3E606F', label: '" . format_dateup($ngayarr[$i]) . "', content: 'http://localhost/www/TDUONG/admin/hoc-vien-list/$ngayarr[$i]/'},";
                                            $datastr .= "{ y: " . (200 - $data2["dem"]) . ", indexLabelFontColor: '#3E606F', color: '#3E606F', label: '" . format_dateup($ngayarr[$i]) . "', content: 'http://localhost/www/TDUONG/admin/hoc-vien-list/$ngayarr[$i]/'},";
                                        }
                                    ?>
                                ]
                            },
                                    ...
                                    <?php
                                        ...
                                        for($i=0;$i<$n;$i++) {
                                            if(date_create($ngayarr[$i]) < date_create($now)) {
                                                ...
                                                echo "{ y: $data2[dem], orther: '$data2[dem]', indexLabelFontColor: '#69b42e', color: '#69b42e', content: 'http://localhost/www/TDUONG/admin/hoc-vien-list/$ngayarr[$i]/'},";
                                            } else {
                                                echo "{ y: 0, orther: '', indexLabelFontColor: '#69b42e', color: '#69b42e', content: 'http://localhost/www/TDUONG/admin/hoc-vien-list/$ngayarr[$i]/'},";
                                            }
                                        }
                                    ?>
                                ]
                                    ...
                                    <?php
                                        ...
                                        for($i=0;$i<$n;$i++) {
                                            if (date_create($ngayarr[$i]) < date_create($now)) {
                                                ...
                                                $result2 = mysqli_query($db, $query2);
                                                $data2 = mysqli_fetch_assoc($result2);
                                                echo "{ y: $data2[dem], orther: '$data2[dem]', indexLabelFontColor: 'red', color: 'red', content: 'http://localhost/www/TDUONG/admin/hoc-vien-list/$ngayarr[$i]/'},";
                                            } else {
                                                echo "{ y: 0, orther: '', indexLabelFontColor: 'red', color: 'red', content: 'http://localhost/www/TDUONG/admin/hoc-vien-list/$ngayarr[$i]/'},";
                                            }
                                        }
                                    ?>
                                ]
                                        ...
                                        echo"<td style='padding:0;vertical-align: top;'>
                                            ...
                                            while($data=mysqli_fetch_assoc($result)) {
                                                ...
                                                echo"<tr class='nhom' data-id='$nID'>
                                                    <td><span><a href='http://localhost/www/TDUONG/admin/hoc-vien-chi-tiet/$nID/' target='_blank'>#$nID, $data[name]</a></span></td>
