            ...
            <div id="MAIN">
                ...
                <?php
					...
					if(isset($_GET["xem"])) {
						...
						if($loai) {
							header("location:http://localhost/www/TDUONG/admin/hoc-sinh-diem-danh/$lmID/$monID/$loai/");
							exit();
						}
					}
				?>
                ...
                <div id="main-mid">
                	...
                	<div>
                    	<div class="status">
                        	<form action="http://localhost/www/TDUONG/admin/pre-hoc-sinh-diem-danh/" method="get">
                        		<table class="table">
