                    	...
                    	<div class="status">
                            <table class="table">
                            	<tr>
                                    ...
                                    <td><input class="submit" style="width:50%;font-size:1.375em;" onclick="location.href='http://localhost/www/TDUONG/admin/tai-lieu/<?php echo $_SESSION["lmID"]."/".$_SESSION["mon"]; ?>/'" type="submit" value="Xem" /></td>
                                </tr>
                            	<tr>
                                	<td style="width:50%;"><span>Tài liệu công cộng</span></td>
                                    <td style="width:50%;"><input class="submit" style="width:50%;font-size:1.375em;" onclick="location.href='http://localhost/www/TDUONG/admin/tai-lieu/0/0/'" type="submit" value="Xem" /></td>
                                </tr>
                            </table>
                    </div>
               	</div>
