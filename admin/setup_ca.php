                            ...
                            <div class="main-bot" style="display:block;">
                                <table class="table" style="margin-top: 25px;">
                                    <tr>
                                        ...
                                        <th style="border: none;"><input type="submit" class="submit" value="Khung giờ" onclick="location.href='http://localhost/www/TDUONG/admin/gio/<?php echo $lmID."/".$monID; ?>/'" /></th>
                                        <th style="border: none;"></th>
                                        <th style="border: none;"></th>
                                    </tr>
                                    <tr>
                                        <td class="hidden"><span>Dạng hiển thị</span></td>
                                        <th><input type="submit" class="submit" value="Liệt kê" onclick="location.href='http://localhost/www/TDUONG/admin/ca/<?php echo $lmID."/".$monID; ?>/'" /></th>
                                        <th><input type="submit" class="submit" value="Bảng chọn" onclick="location.href='http://localhost/www/TDUONG/admin/cai-dat-ca/<?php echo $lmID."/".$monID; ?>/'" /></th>
                                        <?php
                                            if($lmID!=0) {
                                                echo"<th><input type='submit' style='background:red;' class='submit' value='Kiểm tra' onclick=\"location.href='http://localhost/www/TDUONG/admin/cai-dat-ca/0/$monID/'\" /></th>";
                                            } else {
                                                echo"<th><input type='submit' style='background:red;' class='submit' value='Ca học' onclick=\"location.href='http://localhost/www/TDUONG/admin/cai-dat-ca/$_SESSION[lmID]/$monID/'\" /></th>";
                                            }
                                        ?>
                                    </tr>
                                </table>
...
//                                                        }
                                                        ...
                                                        echo"<td class='has-ca'>
                                                            <div class='tab-num' onclick=\"location.href='http://localhost/www/TDUONG/admin/ca-hien-tai/$data3[ID_CA]/'\" style='cursor:pointer'><span>$num</span></div>
                                                            <nav>
