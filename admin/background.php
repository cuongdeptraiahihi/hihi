...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>       
        ...
        <script>
		$(document).ready(function(){$("#MAIN #main-mid .status .table").delegate("tr td input.chose","click",function(){return backID=$(this).attr("data-backID"),$.ajax({async: true,data:"backID0="+backID,type:"post",url:"http://localhost/www/TDUONG/admin/xuly-background/",success:function(t){location.reload()}}),!1}),$("#MAIN #main-mid .status .table").delegate("tr td input.delete","click",function(){return confirm("Bạn có chắc chắn xóa ảnh này không?")?(backID=$(this).attr("data-backID"),$.ajax({async: true,data:"backID="+backID,type:"post",url:"http://localhost/www/TDUONG/admin/xuly-background/",success:function(t){location.reload()}}),!1):void 0})});
		</script>
                ...
                <div id="main-mid">
                	...
                	<div>
                    	<div class="status">	
                            	<table class="table">
                                	<tr>
                                        <td><input type="submit" class="submit" onclick="location.href='http://localhost/www/TDUONG/admin/hoc-sinh-tong-quan/<?php echo get_hs_id_rand($monID); ?>/1/'" value="Test" /></td>
                                    	<td></td>
                                        <td><input type="submit" class="submit" onclick="location.href='http://localhost/www/TDUONG/admin/add-background/'" value="Thêm ảnh" /></td>
                                    </tr>
