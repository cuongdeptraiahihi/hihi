...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>       
        ...
        <script type="text/javascript" src="http://localhost/www/TDUONG/admin/js/jquery.tablednd.js"></script>
                	...
                	<div>
                    	<div class="status">	
                                    ...
                                    while($data=mysqli_fetch_assoc($result)) {
                                        ...
                                        echo"<td><span>$data[level]</span></td>
                                            ...
                                            if($data["status"]==1) {
                                                ...
                                                echo"<td><input type='button' class='submit' value='Sửa' onclick=\"location.href='http://localhost/www/TDUONG/admin/sua-game-tet/$data[ID_STT]/'\" />";
                            ...
                            <table class="table" style="margin-top: 25px;min-width: 600px;">
                                <tr>
                                    <td colspan="50">
                                        <input type="button" class="submit" value="Thêm vòng" onclick="location.href='http://localhost/www/TDUONG/admin/them-game-tet/'" />
