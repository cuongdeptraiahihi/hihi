                        ...
                        data: [
                            {
                                ...
                                dataPoints: [
                                    ...
                                    while(true) {
                                        ...
                                        echo "{y:$data5[dem], indexLabelFontColor: '', color: '', label: '$c', content: 'http://localhost/www/TDUONG/admin/hoc-sinh-vao-ra/in/$b-".format_month_db($a)."/'},";
                                        $a++;
                                        if($a==13) {
                                            $a= 01;
                                            $b++;
...

                            {
                                ...
                                dataPoints: [
                                    ...
                                    while(true) {
                                        ...
                                        echo "{y: ".($data6["dem"]+$data7["dem"]).", indexLabelFontColor: '', color: '', label: '', content: 'http://localhost/www/TDUONG/admin/hoc-sinh-vao-ra/out/$b-".format_month_db($a)."/'},";
                                        $a++;
                                        if($a==13) {
                                            $a= 01;
                                            $b++;
