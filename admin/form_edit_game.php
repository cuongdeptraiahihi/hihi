        ...
        <?php
            ...
            if(isset ($_POST["OK"])) {
                ...
                if($pass && $domain) {
                    ...
                    header('location: http://localhost/www/TDUONG/admin/game-tet/');
                    exit();
                }
            }
        ?>
        ...
        <div id="BODY">
            ...
            <div id="MAIN">
                ...
                <div id="main-mid">
                    ...
                    <div>
                        <div class="status">
                            <form action='http://localhost/www/TDUONG/admin/sua-game-tet/<?php echo $data0["ID_STT"]; ?>/' method='post' enctype='multipart/form-data'>
                                <table class="table">
                                    <tr>
