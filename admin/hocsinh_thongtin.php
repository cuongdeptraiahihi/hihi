    ...
    <head>       
            ...
            changeYear: true });
				...
				$("#bieu-do").click(function() {
					$.ajax({
						...
						data: "bieudo=all",
						type: "post",
						url: "http://localhost/www/TDUONG/admin/xuly-thongke/",
						success: function() {
							location.reload();
						}
					});
		...
		var chart = new CanvasJS.Chart("chart1",
		{
			...
			data: [{
				...
				dataPoints: [
					{ y: <?php echo $hoc_hop; ?>, color: "#eacdb7", name: "Đang học - Đã họp", content: "http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin/<?php echo $lmID."/".$monID; ?>/1/1/"},
					{ y: <?php echo $hoc_kohop; ?>, color: "#3E606F", name: "Đang học - Chưa họp", content: "http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin/<?php echo $lmID."/".$monID; ?>/1/0/"},
					{ y: <?php echo $nghi; ?>, color: "#96c8f3", name: "Nghỉ học", content: "http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin/<?php echo $lmID."/".$monID; ?>/0/1/"},
				]
			}]
		});
		chart.render();
		...
		var chart2 = new CanvasJS.Chart("chart2",
		{
			...
			data: [
			{
				...
				dataPoints: [
					{ y: <?php echo $none_face; ?>, color: "#96c8f3", label: "KHÔNG DÙNG", content: "http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin-face/<?php echo $lmID."/".$monID; ?>/X/"},
					{ y: <?php echo $no_add; ?>, color: "red", label: "CHƯA ADD", content: "http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin-face/<?php echo $lmID."/".$monID; ?>/0/"},
					{ y: <?php echo $add_face; ?>, color: "#e7a53f", label: "ĐÃ ADD", content: "http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin-face/<?php echo $lmID."/".$monID; ?>/1/"}
				]
			},
			]
		});
		...
		var chart3 = new CanvasJS.Chart("chart3",
		{
			...
			data: [
			{
				...
				dataPoints: [
					{ y: <?php echo $nam_nghi; ?>, label: "NAM", content: "http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin-nghi/<?php echo $lmID."/".$monID; ?>/1/0/"},
					{ y: <?php echo $nu_nghi; ?>, label: "NỮ", content: "http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin-nghi/<?php echo $lmID."/".$monID; ?>/0/0/"},
				]
			},
			{
				type: "stackedColumn",
				...
				dataPoints: [
					{ y: <?php echo ($nam_sl-$nam_nghi); ?>, label: "NAM", content: "http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin-nghi/<?php echo $lmID."/".$monID; ?>/1/1/"},
					{ y: <?php echo ($nu_sl-$nu_nghi); ?>, label: "NỮ", content: "http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin-nghi/<?php echo $lmID."/".$monID; ?>/0/1/"},
				]
			},
			]
		});
		...
		var chart4 = new CanvasJS.Chart("chart4",
		{
			...
			data: [
			{
				...
				dataPoints: [
					{ y: <?php echo $i_phone2; ?>, label: "SỐ CÁ NHÂN", content: "http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin-sdt/<?php echo $lmID."/".$monID; ?>/1/0/"},
					{ y: <?php echo $bo_phone2; ?>, label: "SỐ ĐT BỐ", content: "http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin-sdt/<?php echo $lmID."/".$monID; ?>/2/0/"},
					{ y: <?php echo $me_phone2; ?>, label: "SỐ ĐT MẸ", content: "http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin-sdt/<?php echo $lmID."/".$monID; ?>/3/0/"},
				]
			},
			{
				type: "stackedColumn",
				...
				dataPoints: [
					{ y: <?php echo $i_phone; ?>, label: "SỐ CÁ NHÂN", content: "http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin-sdt/<?php echo $lmID."/".$monID; ?>/1/1/"},
					{ y: <?php echo $bo_phone; ?>, label: "SỐ ĐT BỐ", content: "http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin-sdt/<?php echo $lmID."/".$monID; ?>/2/1/"},
					{ y: <?php echo $me_phone; ?>, label: "SỐ ĐT MẸ", content: "http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin-sdt/<?php echo $lmID."/".$monID; ?>/3/1/"},
				]
			},
			]
		});
		...
		var chart8 = new CanvasJS.Chart("chart8",
		{
			...
			data: [
			{
				...
				toolTipContent: "<a href = {content}>{label}: {y}</a>",  
				dataPoints: [
					{ y: <?php echo $no_van; ?>, color: "red", label: "THIẾU", content: "http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin-van/<?php echo $lmID."/".$monID; ?>/0/"},
					{ y: <?php echo $has_van; ?>, color: "#e7a53f", label: "ĐÃ CÓ", content: "http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin-van/<?php echo $lmID."/".$monID; ?>/1/"}
				]
			},
			]
		});
            	...
            	<?php
					...
					if(isset($_POST["set-ok"])) {
						...
						if($loai==1) {
							...
							if($ma1 && $ma2) {
								header("location:http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin-loai/$lmID/$monID/$loai/$ma1/$ma2/");
								exit();
							} else {
								header("location:http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin-loai/$lmID/$monID/0/");
								exit();
							}
						} else if($loai==2) {
							if(isset($_POST["ma"])) {
								$ma=$_POST["ma"];
                                header("location:http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin-loai/$lmID/$monID/$loai/$ma/");
                                exit();
							}
						} else if($loai==4) {
						    if(isset($_POST["birth"])) {
						        $birth=$_POST["birth"];
                                header("location:http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin-birth/$lmID/$monID/$loai/$birth/");
                                exit();
                            }
						} else {
                            header("location:http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin-loai/$lmID/$monID/$loai/");
                            exit();
                        }
					}
...
<!--                            	<div style="position:absolute;left:0;top:0;"><input type="submit" class="submit" id="bieu-do" value="Biểu đồ" /></div>-->
                                ...
                                <ul id="main-right">
                                	<li style="width:37.5%;">
                                        ...
                                        <?php if($sort=="nghi-desc") { ?>
                                        	<i class="fa fa-sort-amount-asc" style="margin-right:15px;cursor:pointer" onclick="location.href='http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin-sort/<?php echo $lmID."/".$monID; ?>/nghi-asc/'"></i>
                                        <?php } else { ?>
                                       		<i class="fa fa-sort-amount-desc" style="margin-right:15px;cursor:pointer" onclick="location.href='http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin-sort/<?php echo $lmID."/".$monID; ?>/nghi-desc/'"></i>
										<?php } ?>
                                    ...
                                    <li style="width:25%;">
                                    	<div class="chart-top" style="background:#3E606F;cursor:pointer;" onclick="location.href='http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin/<?php echo $lmID."/".$monID; ?>/'"><span>Trường</span></div>
                                        <div class="chart-main2">
                                        <?php
											$tr=0;
											$tr_max=$n>25?25:$n;
											while($tr<$tr_max) {
												echo"<ol><a href='http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin-truong/$lmID/$monID/".$hoc_array[$tr]["id"]."/'>".substr($hoc_array[$tr]["name"],4)."</a></ol>";
												$tr++;
											}
										?>
                                       	</div>
                                    ...
                                    <li style="width:37.5%;">
                                        ...
                                        <?php if($sort=="hoc-desc") { ?>
                                        	<i class="fa fa-sort-amount-asc" style="margin-left:15px;cursor:pointer" onclick="location.href='http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin-sort/<?php echo $lmID."/".$monID; ?>/hoc-asc/'"></i>
                                        <?php } else { ?>
                                       		<i class="fa fa-sort-amount-desc" style="margin-left:15px;cursor:pointer" onclick="location.href='http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin-sort/<?php echo $lmID."/".$monID; ?>/hoc-desc/'"></i>
										<?php } ?>
                                        </span></div>
                            ...
                            <?php
								if($truongID==0) {
							?>
                            	<form action="http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin/<?php echo $lmID."/".$monID; ?>/" method="post">
                            	<table class="table">
                                	<tr>
                                    	<th style="width:25%;">
...
//									echo"<li><a href='http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin/$lmID/$monID/page/$prev/'><</a></li>";
//								}
//								for($page=1;$page<=$sum_page;$page++) {
//									$begin=($page-1)*$display;
//									if($page==$current) {
//										echo"<li><a href='http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin/$lmID/$monID/page/$begin/' style='font-weight:bold;text-decoration:underline;'>$page</a></li>";
//									} else {
//										echo"<li><a href='http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin/$lmID/$monID/page/$begin/'>$page</a></li>";
//									}
//								}
//								if($current!=$sum_page) {
//									$next=$position+$display;
//									echo"<li><a href='http://localhost/www/TDUONG/admin/hoc-sinh-thong-tin/$lmID/$monID/page/$next/'>></a></li>";
//								}
//							?>
<!--                            </ul>-->
<!--                        </div>-->
