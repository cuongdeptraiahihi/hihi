                    	...
                    	<div class="status">
                            <table class="table">
                                <tr>
                                    ...
                                    <td style="border: none;"><input type="submit" class="submit" value="Khung giờ" onclick="location.href='http://localhost/www/TDUONG/admin/gio/<?php echo $lmID."/".$monID; ?>/'" /></td>
                            ...
                            <table class="table" style="margin-top:25px;">
                                ...
                                ?> 
                                    ...
                                    <td class='hidden'>
                                        <input type="submit" class="submit" onclick="location.href='http://localhost/www/TDUONG/admin/ca-hien-tai/<?php echo $data["ID_CA"];?>/'" value="Hiện tại" />
                                        <input type="submit" class="submit" onclick="location.href='http://localhost/www/TDUONG/admin/ca-co-dinh/<?php echo $data["ID_CA"];?>/'" value="Cố định" />
