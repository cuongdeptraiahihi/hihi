			...
			$("#MAIN #main-mid .status .table").delegate("tr td input.edit_ok", "click", function() {
				...
				if(name!="" && $.isNumeric(price) && date_in!="" && $.isNumeric(oID) && oID!=0 && ajax_data!="" && sum>=0 && sum<=100) {
					$.ajax({
						...
						data: "data=" + ajax_data,
						type: "post",
						url: "http://localhost/www/TDUONG/admin/xuly-trogiang/",
            ...
            <div id="MAIN">
                ...
                <?php
                    if(isset($_POST["ok-fix"])) {
                        ...
                        header("location:http://localhost/www/TDUONG/admin/tro-giang/");
                        exit();
                    }
                ?>
                    	...
                    	<div class="status">	
                            	<table class="table">
                                	<tr>
                                        ...
                                        <td>
                                            <form action="http://localhost/www/TDUONG/admin/tro-giang/" method="post">
