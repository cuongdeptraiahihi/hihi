...
<!--                    	<h3>Menu</h3>-->
<!--                        <ul>-->
<!--                            <li class="action"><a href="http://localhost/www/TDUONG/admin/chuyen-de/--><?php //echo $lmID; ?><!--/"><i class="fa fa-newspaper-o"></i>CHUYÊN ĐỀ</a></li>-->
<!--                            --><?php
//								$result1=get_all_chuyende_con($lmID);
//								while($data1=mysqli_fetch_assoc($result1)) {
//									echo"<li class='action'><a href='http://localhost/www/TDUONG/admin/tai-lieu-chuyen-de/$data1[ID_CD]/'><i class='fa fa-folder-o'></i>$data1[title]</a></li>";
//								}
//                                $result1=get_danhmuc($lmID,$monID);
//                                while($data1=mysqli_fetch_assoc($result1)) {
//                                    echo"<li class='action'><a href='http://localhost/www/TDUONG/admin/tai-lieu-danh-muc/$data1[ID_DM]/'><i class='fa fa-folder-o'></i>$data1[title]</a></li>";
//                                }
//							?>
<!--                        </ul>-->
<!--                    </div>-->
                    ...
                    if(isset($_POST["loc-ok"])) {
                        if(isset($_POST["loc-chon"])) {
                            ...
                            if($loai_chon==0 || $loai_chon==1) {
                                header("location:http://localhost/www/TDUONG/admin/tai-lieu-chuyen-de/$cdID/$loai_chon/");
                                exit();
                            }
                        }
                    }
...
<!--                            </div>-->
<!--                            --><?php //} ?>
<!--                            <form action="http://localhost/www/TDUONG/admin/tai-lieu-chuyen-de/--><?php //echo $cdID; ?><!--/" method="post">-->
                                ...
                                <?php
									...
									while($data2=mysqli_fetch_assoc($result2)) {
										...
										echo"<tr>
											...
											echo"</span></td>
											<td>"; ?>
                                            	<input type="submit" class="submit" onclick="location.href='http://localhost/www/TDUONG/admin/xem-tai-lieu/<?php echo $data2["ID_TL"]; ?>/'" value="Xem" />
												<input type="submit" class="submit" onclick="location.href='http://localhost/www/TDUONG/admin/sua-tai-lieu/<?php echo $data2["ID_TL"]; ?>/'" value="Sửa" />
