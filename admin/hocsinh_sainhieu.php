      	...
      	<div id="BODY">
            ...
            <div id="MAIN">
                ...
                <?php
                    if(isset($_POST["xem"])) {
                        if(isset($_POST["buoi"]) && is_numeric($_POST["buoi"]) && $_POST{"buoi"}!=0) {
                            $buoi=$_POST["buoi"];
                            header("location:http://localhost/www/TDUONG/admin/hoc-sinh-sai-nhieu/$lmID/$buoi/");
                            exit();
                        } else {
                            header("location:http://localhost/www/TDUONG/admin/hoc-sinh-sai-nhieu/$lmID/");
                            exit();
                        }
                    }
                ?>
                ...
                <div id="main-mid">
                	...
                	<div>
                    	<div class="status">
                            <form action="http://localhost/www/TDUONG/admin/hoc-sinh-sai-nhieu/<?php echo $lmID; ?>/" method="post">
                                <table class="table">
                                    <tr>
