            ...
            <div id="MAIN">
            	...
            	<div id="main-left">
                    ...
                    <div>
                    	<h3>Menu</h3>
                        <ul>
                            <li class="action"><a href="http://localhost/www/TDUONG/admin/sms/"><i class="fa fa-newspaper-o"></i>Thông báo tiền học tháng <?php echo $thang_toi; ?> (Excel)</a></li>
                            <li class="action"><a href="http://localhost/www/TDUONG/admin/sms-tuy-chon/"><i class="fa fa-newspaper-o"></i>Nội dung tùy chọn</a></li>
                            <li class="action"><a href="http://localhost/www/TDUONG/admin/sms-tu-dong/"><i class="fa fa-newspaper-o"></i>SMS đơn lẻ</a></li>
                        </ul>
                    </div>
                ...
                <div id="main-mid">
                	...
                	<div>
                    	<div class="status">
                            <?php echo $error; ?>
                            <form action="http://localhost/www/TDUONG/admin/sms-tuy-chon/" method="post">
                                <table class="table">
