                        ...
                        <div class="page-number">
                            ...
                            <?php
								if($current!=1) {
									...
									echo"<li><a href='http://localhost/www/TDUONG/admin/dong-bo/page-$prev/'><</a></li>";
								}
								for($page=1;$page<=$sum_page;$page++) {
									$begin=($page-1)*$display;
									if($page==$current) {
										echo"<li><a href='http://localhost/www/TDUONG/admin/dong-bo/page-$begin/' style='font-weight:bold;text-decoration:underline;'>$page</a></li>";
									} else {
										echo"<li><a href='http://localhost/www/TDUONG/admin/dong-bo/page-$begin/'>$page</a></li>";
									}
								}
								if($current!=$sum_page) {
									$next=$position+$display;
									echo"<li><a href='http://localhost/www/TDUONG/admin/dong-bo/page-$next/'>></a></li>";
								}
							?>
                            </ul>
                        </div>
