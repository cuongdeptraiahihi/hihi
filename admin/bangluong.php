...
//                                        <td class='need-ex'>
//                                            <a href='http://localhost/www/TDUONG/admin/bang-luong-tro-giang/$nam-$thang/' target='_blank'>" . format_price($luong_tinh) . "</a>
//                                        </td>
//                                    </tr>";
//                                    $luong+=$luong_tinh;
//                                }
...
//                                                $tien_thuong = $data["thuong_price"];
                                            ...
                                            if ($hs_bt != 0) {
                                                if($nam >= 2017 && $thang >= 6) {
                                                    echo "<td class='need-ex'>
                                                        <a href='http://localhost/www/TDUONG/admin/bang-luong-chi-tiet/$data5[ID_LM]/$nam-$thang/1/' target='_blank'>$hs_bt em = " . format_price($tien*(2/3)) . "<br /> = " . format_price($hs_bt * $tien * (2/3)) . "</a>
                                                    </td>";
                                                    $tien_tra = $tien * (2/3);
                                                } else {
                                                    if ($hs_bt * $muc_tien > $tien) {
                                                        echo "<td class='need-ex' style='background:yellow'>
                                                            <a href='http://localhost/www/TDUONG/admin/bang-luong-chi-tiet/$data5[ID_LM]/$nam-$thang/1/' target='_blank'>$hs_bt em x " . format_price($tien_tra) . "<br /> = " . format_price($hs_bt * $tien_tra) . "</a>
                                                        </td>";
                                                    } else {
                                                        echo "<td class='need-ex'>
                                                            <a href='http://localhost/www/TDUONG/admin/bang-luong-chi-tiet/$data5[ID_LM]/$nam-$thang/1/' target='_blank'>$hs_bt em x " . format_price($tien_tra) . "<br /> = " . format_price($hs_bt * $tien_tra) . "</a>
                                            ...
                                            if ($hs_giam != 0) {
                                                echo "<td>
                                                        <a href='http://localhost/www/TDUONG/admin/bang-luong-chi-tiet/$data5[ID_LM]/$nam-$thang/2/' target='_blank'>$hs_giam em = " . format_price($tien_giam) . "</a>
                                                    </td>";
                                            } else {
                                            ...
                                            if ($hs_new != 0) {
                                                echo "<td>
                                                        <a href='http://localhost/www/TDUONG/admin/bang-luong-chi-tiet/$data5[ID_LM]/$nam-$thang/3/' target='_blank'>$hs_new em = " . format_price($tien_new) . "</a>
                                                    </td>";
                                            } else {
                                                echo "<td><span></span></td>";
                                            }
                                            if ($hs_no != 0) {
                                                echo "<td>
                                                        <a href='http://localhost/www/TDUONG/admin/bang-luong-chi-tiet/$data5[ID_LM]/$nam-$thang/4/' target='_blank'>$hs_no em</a>
                                                    </td>";
                                            } else {
                                                echo "<td><span></span></td>";
                                            }
//                                            if ($hs_nghi != 0) {
//                                                echo "<td>
//                                                        <a href='http://localhost/www/TDUONG/admin/bang-luong-chi-tiet/$data5[ID_LM]/$nam-$thang/5/' target='_blank'>$hs_nghi em</a>
//                                                    </td>";
//                                            } else {
//                                                echo "<td><span></spam></td>";
//                                            }
//                                            echo "<td>
//                                                    <a href='http://localhost/www/TDUONG/admin/bang-luong-chi-tiet/$data5[ID_LM]/$nam-$thang/6/' target='_blank'>-" . format_price($tien_thuong) . "</a>
//                                                </td>";
