        ...
        <?php
			...
			if(isset($_POST["up"])) {
				...
				if($image) {
					...
					header("location:http://localhost/www/TDUONG/admin/background/");
					exit();
				} else {
      	...
      	<div id="BODY">
            ...
            <div id="MAIN">
                ...
                <div id="main-mid">
                	...
                	<div>
                    	<div class="status">
                        	<form action="http://localhost/www/TDUONG/admin/add-background/" method="post" enctype="multipart/form-data">
                            	<table class="table">
                                	<tr>
