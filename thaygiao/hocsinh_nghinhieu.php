                ...
                <div id="main-mid">
                	...
                	<div>
                        ...
                        <div class="page-number">
                            <ul>
                                <li><a href='http://localhost/www/TDUONG/thaygiao/hoc-sinh-nghi-nhieu/<?php echo $lmID; ?>/<?php echo $monID; ?>/page/<?php if($position>0){echo ($position-20);}else{echo 0;} ?>/'><</a></li>
                                <li><a href='http://localhost/www/TDUONG/thaygiao/hoc-sinh-nghi-nhieu/<?php echo $lmID; ?>/<?php echo $monID; ?>/page/<?php echo ($position+20); ?>/'>></a></li>
                            </ul>
                        </div>
                    </div>
               	</div>
