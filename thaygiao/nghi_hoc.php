                                ...
                                <?php
									...
									while($data2=mysqli_fetch_assoc($result2)) {
										...
										echo"<th style='background: #3E606F;' class='hidden'><span>".($dem+1)."</span></th>
											<th style='background: #EF5350;'><span><a href='".formatFacebook($data2["facebook"])."' target='_blank'>$data2[fullname]</a><br /><a href='http://localhost/www/TDUONG/thaygiao/hoc-sinh-chi-tiet/ma/$data2[cmt]/' target='_blank'>$data2[cmt]</a></span></td>
