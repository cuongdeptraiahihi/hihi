...
<!--        <div id="top-logo"><a href="http://localhost/www/TDUONG/thaygiao/home/"><img src="http://localhost/www/TDUONG/thaygiao/images/logo.jpg" /></a></div>-->
        <ul>
            ...
            echo"<li><nav><select class='input' style='border-radius:6px;width:100%;height:100%;text-align-last:center;font-size: 12px;text-transform: uppercase;color:#FFF;background:#3E606F;border:1px solid #3E606F;border-bottom:2px solid #3E606F;font-weight: 600;' id='CHANGE_MON'>";
                $result = get_all_lop_mon();
                while($data=mysqli_fetch_assoc($result)) {
