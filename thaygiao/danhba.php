		...
		$(document).ready(function() {
            ...
            $("#cap-quyen").click(function () {
                if(confirm("Bạn có chắc chắn, bạn sẽ được hỏi về quyền truy cập danh bạn tài khoản Google!")) {
                    window.open("http://localhost/www/TDUONG/thaygiao/cap-quyen/","_blank");
                } else {
                    return false;
                }
            });
...
//            echo $array_var;
            ...
            <div id="MAIN">
                ...
                <div id="main-mid">
                	...
                	<div>
                    	<div class="status">
                            <form action="http://localhost/www/TDUONG/thaygiao/danh-ba/<?php echo $lmID; ?>/" method="post">
...
//                }
                ...
                header("location:http://localhost/www/TDUONG/thaygiao/danh-ba/$lmID/");
                exit();
            }
            ?>
        </div>
