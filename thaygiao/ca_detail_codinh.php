            ...
            <div id="MAIN">
            	...
            	<div id="main-left">
                    ...
                    <div>
                    	<h3>Thao tác</h3>
                        <ul>
                        	<li class="action"><a href="http://localhost/www/TDUONG/thaygiao/ca-hien-tai/<?php echo $caID;?>/"><i class="fa fa-angle-double-right"></i>Xem danh sách hiện tại</a></li>
                        </ul>
                    </div>
                </div>
                <div id="main-mid">
								...
								echo"<li><a href='javascript:void(0)'># Cụm $data1[name]</a>
									<ul class='sub-menu'>";
										...
										while($data4=mysqli_fetch_assoc($result4)) {
											echo"<ol><a href='http://localhost/www/TDUONG/thaygiao/ca-co-dinh/$data4[ID_CA]/' ";if($data4["ID_CA"]==$caID){echo"style='font-weight:600'";}echo"><i class='fa fa-caret-right'></i>".$thu_string[$data4["thu"]-1].", $data4[gio]</a></ol>";
										}
									echo"</ul>
								</li>";
							}
