      	...
      	<div id="BODY">
            ...
            <?php
                ...
                if(isset($_POST["xem"])) {
                    ...
                    if(($ngay!="" || ($ngay_start!="" && $ngay_end!="") || ($seri_start && $seri_end)) && !$error) {
                        switch ($kieu) {
                            case 1:
                                header("location:http://localhost/www/TDUONG/thaygiao/kiem-tra-tien/ngay/$staff/$ngay/");
                                exit();
                                break;
                            case 2:
                                header("location:http://localhost/www/TDUONG/thaygiao/kiem-tra-tien/khoang-ngay/$staff/$ngay_start/$ngay_end/");
                                exit();
                                break;
                            case 3:
                                header("location:http://localhost/www/TDUONG/thaygiao/kiem-tra-tien/khoang-seri/$staff/$seri_start/$seri_end/");
                                exit();
                                break;
                            default:
                                header("location:http://localhost/www/TDUONG/thaygiao/kiem-tra-tien/");
                                exit();
                                break;
                        }
                    }
            ...
            <div id="MAIN">
                ...
                <div id="main-mid">
                	...
                	<div>
                    	<div class="status">
                            <form action="http://localhost/www/TDUONG/thaygiao/kiem-tra-tien/" method="post" style="width:29%;display: inline-table;">
