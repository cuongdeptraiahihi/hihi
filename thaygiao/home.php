        ...
        <script>
			$(document).ready(function() {
                ...
                $("a.chot-nghi").click(function() {
                    ...
                    $("#popup-view").attr("data-link","http://localhost/www/TDUONG/thaygiao/xem-nghi-hoc/"+cumID+"/"+lmID+"/<?php echo $monID; ?>/");
                    ...
                    while($data=mysqli_fetch_assoc($result)) {
                        ...
                        while ($data4 = mysqli_fetch_assoc($result4)) {
                            ...
                            if (($cumID != $data4["ID_CUM"] && $dem != 0)) {
                                ...
                                $noidung0 = "{label: '" . substr($con, 3) . "', y: ".($dem30).", indexLabel: '";if($dem30!=0) {$noidung0.="$dem30";}$noidung0.="', name: '$dem30', content: 'http://localhost/www/TDUONG/thaygiao/hoc-sinh-nghi-hoc/$cumID/$data[ID_LM]/$data[ID_LM]/0/'},";
                                $noidung1 = "{label: '" . substr($con, 3) . "', y: ".(-$dem31).", indexLabel: '";if($dem31!=0) {$noidung1.="$dem31";}$noidung1.="', name: '$dem31', content: 'http://localhost/www/TDUONG/thaygiao/hoc-sinh-nghi-hoc/$cumID/$data[ID_LM]/$data[ID_LM]/1/'},";
                                $noidung2 = "{label: '" . substr($con, 3) . "', y: ".($dem32).", indexLabel: '', name: '$dem32', content: 'http://localhost/www/TDUONG/thaygiao/hoc-sinh-nghi-hoc/$cumID/$data[ID_LM]/$data[ID_LM]/5/'},";
                    ...
                    while ($data4 = mysqli_fetch_assoc($result4)) {
                        ...
                        if (($cumID != $data4["ID_CUM"] && $dem != 0)) {
                            for($i=0;$i<count($lmID_arr);$i++) {
                                ...
                                $max = $max > ($dem30+$dem32) ? $max : ($dem30+$dem32);
                                $max = $max > $dem31 ? $max : $dem31;
                                $noidung0 = "{label: '" . substr($con, 3) . "', y: ".($dem30).", indexLabel: '";if($dem30!=0) {$noidung0.="$dem30";}$noidung0.="', name: '$dem30', content: 'http://localhost/www/TDUONG/thaygiao/hoc-sinh-nghi-hoc/$cumID/0/".$lmID_arr[$i]["ID_LM"]."/0/'},";
                                $noidung1 = "{label: '" . substr($con, 3) . "', y: ".(-$dem31).", indexLabel: '";if($dem31!=0) {$noidung1.="$dem31";}$noidung1.="', name: '$dem31', content: 'http://localhost/www/TDUONG/thaygiao/hoc-sinh-nghi-hoc/$cumID/0/".$lmID_arr[$i]["ID_LM"]."/1/'},";
                                $noidung2 = "{label: '" . substr($con, 3) . "', y: ".($dem32).", indexLabel: '', name: '$dem32', content: 'http://localhost/www/TDUONG/thaygiao/hoc-sinh-nghi-hoc/$cumID/0/".$lmID_arr[$i]["ID_LM"]."/5/'},";
                                $ngay=get_last_cum_date($cumID,$data["ID_LM"],$monID);
                                        ...
                                        <p style='border: 1px solid #3E606F;padding-left:1.2%;'>";
                                            for($i=count($cum_arr[$lmID_arr[$dem]["ID_LM"]])-1;$i>=0;$i--) {
                                                ...
                                                if(!check_done_options($cum_arr[$lmID_arr[$dem]["ID_LM"]][$i]["cumID"],"diemdanh-nghi",$cum_arr[$lmID_arr[$dem]["ID_LM"]][$i]["lmID"],$monID)) {
                                                    ...
                                                    echo"<a href='http://localhost/www/TDUONG/thaygiao/hoc-sinh-nghi-hoc/".$cum_arr[$lmID_arr[$dem]["ID_LM"]][$i]["cumID"]."/".$cum_arr[$lmID_arr[$dem]["ID_LM"]][$i]["lmID"]."/".$lmID_arr[$dem]["ID_LM"]."/0/' style='background:#3E606F;border-radius:100px;display:block;height:10px;width:10px;margin:auto;'></a>
