                    	...
                    	<div class="status">
                            <div class="main-bot" style="display:block;">
                                ...
                                <table class="table" id="list-nghihoc">
                                    <tr>
                                        <form action="http://localhost/www/TDUONG/thaygiao/xem-nghi-hoc/<?php echo $cum; ?>/<?php echo $lmID; ?>/<?php echo $monID; ?>/" method="post" enctype="multipart/form-data">
                                            <td class="hidden"></td>
                                    ...
                                    <?php
										...
										while($data2=mysqli_fetch_assoc($result2)) {
											...
											if(isset($data2["ID_N"])) {
											    ...
											    <th style='background: #EF5350;'><span><a href='".formatFacebook($data2["facebook"])."' target='_blank'>$data2[fullname]</a><br /><a href='http://localhost/www/TDUONG/thaygiao/hoc-sinh-chi-tiet/ma/$data2[cmt]/' target='_blank'>($data2[cmt])</a><br />".get_hs_lich_hoc($data2["ID_HS"],$lmID,$monID)."</span></th>
