			...
			$("#search-video").keyup(function() {
				...
				if(text != '' && text != '%' && text != ' ' && text != '_') {
					$.ajax({
						...
						data: "search=" + text,
						type: "get",
						url: "http://localhost/www/TDUONG/thaygiao/xuly-search-video/",
						success: function(result) {
            ...
            <div id="MAIN">
                ...
                <?php
					...
					if(isset($_GET["xem"])) {
						...
						if($mon && $cd) {
							header("location:http://localhost/www/TDUONG/thaygiao/videos/$mon/$cd/");
							exit();
						}
					}
				?>
                ...
                <div id="main-mid">
                	...
                	<div>
                    	<div class="status">
                        	<table class="table">
                            	<tr><td><input type="submit" class="submit" style="width:50%;font-size:1.375em;" onclick="location.href='http://localhost/www/TDUONG/thaygiao/up-video/'" value="Up video" /></td></tr>
                            </table>
                        	<form action="http://localhost/www/TDUONG/thaygiao/videos/" method="get">
							...
							?>
                            	<table class="table" style="margin-top:25px;">
									...
									?> 
                                        ...
                                        <td>
                                            <input type="submit" class="submit" onclick="location.href='http://localhost/www/TDUONG/thaygiao/video/<?php echo $data["ID_VIDEO"];?>/'" value="Xem" />
                                            <input type="submit" class="submit" onclick="location.href='http://localhost/www/TDUONG/thaygiao/sua-video/<?php echo $data["ID_VIDEO"];?>/'" value="Sửa" />
                        ...
                        <div class="page-number">
                            ...
                            <?php
								if($current!=1) {
									...
									echo"<li><a href='http://localhost/www/TDUONG/thaygiao/videos/page-$prev/'><</a></li>";
								}
								for($page=1;$page<=$sum_page;$page++) {
									$begin=($page-1)*$display;
									if($page==$current) {
										echo"<li><a href='http://localhost/www/TDUONG/thaygiao/videos/page-$begin/' style='font-weight:bold;text-decoration:underline;'>$page</a></li>";
									} else {
										echo"<li><a href='http://localhost/www/TDUONG/thaygiao/videos/page-$begin/'>$page</a></li>";
									}
								}
								if($current!=$sum_page) {
									$next=$position+$display;
									echo"<li><a href='http://localhost/www/TDUONG/thaygiao/videos/page-$next/'>></a></li>";
								}
							?>
                            </ul>
                        </div>
