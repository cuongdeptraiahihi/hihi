		...
		$(document).ready(function() {
			...
			$("#MAIN #main-mid .status .table").delegate("tr td input.view", "click", function() {
				...
				$.ajax({
					...
					data: "nsID0=" + nsID,
					type: "post",
					url: "http://localhost/www/TDUONG/thaygiao/xuly-ngoisao/",
				  ...
				  data: [
				  {
					  ...
					  <?php
						...
						while($i>=0) {
							...
							echo"{ label: '".format_date($buoi_arr[$i])."', y: ".$num.", indexLabel: '{y}', content: 'http://localhost/www/TDUONG/thaygiao/ngoi-sao/$buoi_arr[$i]/$lmID/'},";
							$i--;
						}
					  ?>
					  ]
