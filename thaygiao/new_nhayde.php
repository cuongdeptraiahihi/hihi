			...
			$("#MAIN #main-mid .table tr td input.back").click(function() {
				if(confirm("Bạn có chắc chắn chuyển học sinh này về đề ban đầu?")) {
					...
					$.ajax({
						...
						type: "post",
						url: "http://localhost/www/TDUONG/thaygiao/xuly-nhayde/",
                	...
                	<div>
                    	<div class="status">
                            	<table class="table">
                                	<tr>
                                    	<td></td>
                                        <td><input type="submit" class="submit" onclick="location.href='http://localhost/www/TDUONG/thaygiao/moi-chuyen-de/<?php echo $lmID; ?>/B/'" value="Y,G sang B" /></td>
                                        <td><input type="submit" class="submit" onclick="location.href='http://localhost/www/TDUONG/thaygiao/moi-chuyen-de/<?php echo $lmID; ?>/G/'" value="B sang G" /></td>
                                        <td><input type="submit" class="submit" onclick="location.href='http://localhost/www/TDUONG/thaygiao/moi-chuyen-de/<?php echo $lmID; ?>/Y/'" value="B sang Y" /></td>
                                    </tr>
