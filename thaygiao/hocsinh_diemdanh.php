                    	...
                    	<div class="status">
							...
							<?php if($_SESSION["mobile"]==0) { ?>
                            	<table class="table table3">
                                    ...
                                    <tr>
                                        <?php if($lmID!=0) { ?>
                                        <td colspan="5"><input type="submit" class="submit" value="Buổi kiểm tra" onclick="location.href='http://localhost/www/TDUONG/thaygiao/hoc-sinh-diem-danh/0/<?php echo $monID; ?>/<?php echo $loai; ?>/<?php echo $hsID; ?>/'" /></td>
                                    	<?php } else { ?>
                                        <td colspan="5"><input type="submit" class="submit" value="Ca học" onclick="location.href='http://localhost/www/TDUONG/thaygiao/hoc-sinh-diem-danh/<?php echo $_SESSION["lmID"]; ?>/<?php echo $monID; ?>/<?php echo $loai; ?>/<?php echo $hsID; ?>/'" /></td>
                                        <?php } ?>
<!--                                        <td colspan="2"></td>-->
...
//											}
                        ...
                        <div class="page-number">
                            <ul>
                                <li><a href='http://localhost/www/TDUONG/thaygiao/hoc-sinh-diem-danh/<?php echo $lmID; ?>/<?php echo $monID; ?>/<?php echo $loai; ?>/page/<?php if($position>0){echo ($position-30);}else{echo 0;} ?>/'><</a></li>
                                <li><a href='http://localhost/www/TDUONG/thaygiao/hoc-sinh-diem-danh/<?php echo $lmID; ?>/<?php echo $monID; ?>/<?php echo $loai; ?>/page/<?php echo ($position+30); ?>/'>></a></li>
                            </ul>
                        </div>
                        <?php } ?>
                    </div>
