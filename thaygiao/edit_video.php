        ...
        <?php
			...
			if(isset($_POST["up"])) {
				...
				if($title && $mon && $video && $chuyende && is_numeric($price) && $video_on && $videoID) {
					...
					header("location:http://localhost/www/TDUONG/thaygiao/sua-video/$videoID/");
					exit();
				} else {
      	...
      	<div id="BODY">
            ...
            <div id="MAIN">
                ...
                <div id="main-mid">
                	...
                	<div>
                    	<div class="status">
                        	<form action="http://localhost/www/TDUONG/thaygiao/sua-video/<?php echo $videoID;?>/" method="post" enctype="multipart/form-data">
                            	<table class="table">
                                	<tr>
