            ...
            <div id="MAIN">
            	...
            	<div id="main-left">
                    ...
                    <div>
                    	<h3>Menu</h3>
                        <ul>
                        	<li class="action"><a href="http://localhost/www/TDUONG/thaygiao/pre-ca/"><i class="fa fa-calendar"></i>Danh sách ca học</a></li>
                        	<li class="action"><a href="http://localhost/www/TDUONG/thaygiao/pre-gio/"><i class="fa fa-table"></i>Các khung giờ</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <?php
					...
					if(isset($_GET["xem"])) {
						...
						if($mon && $lop) {
							header("location:http://localhost/www/TDUONG/thaygiao/ca-hoc/$mon/$lop/");
							exit();
						}
					}
				?>
                ...
                <div id="main-mid">
                	...
                	<div>
                    	<div class="status">
                        	<form action="http://localhost/www/TDUONG/thaygiao/ca-hoc/" method="get" style="position:relative;">
