...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>       
        ...
        <script type="text/javascript" src="http://localhost/www/TDUONG/thaygiao/include/ckeditor/ckeditor.js"></script>
        ...
        <?php
			...
			if(isset($_POST["up"])) {
				...
				if($title && $content && is_numeric($danhmuc) && $danhmuc!=0 && $loai && $pic && $where) {
					...
					if($where=="chuyende") {
                        header("location:http://localhost/www/TDUONG/thaygiao/tai-lieu-chuyen-de/$danhmuc/");
                        exit();
                    } else {
                        header("location:http://localhost/www/TDUONG/thaygiao/tai-lieu-danh-muc/$danhmuc/");
                        exit();
                    }
				} else {
      	...
      	<div id="BODY">
            ...
            <div id="MAIN">
                ...
                <div id="main-mid">
                	...
                	<div>
                    	<div class="status">
                        	<form action="http://localhost/www/TDUONG/thaygiao/up-tai-lieu/<?php echo $lmID."/".$monID; ?>/" method="post" enctype="multipart/form-data">
                            	<table class="table">
                                	<tr>
