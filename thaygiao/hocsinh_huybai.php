      	...
      	<div id="BODY">
            ...
            <?php
                ...
                if(isset($_POST["xem"])) {
                    if(isset($_POST["thang"])) {
                        ...
                        header("location:http://localhost/www/TDUONG/thaygiao/hoc-sinh-huy-bai/$month/");
                        exit();
                    }
                }
            ?>
            ...
            <div id="MAIN">
                ...
                <div id="main-mid">
                	...
                	<div>
                    	<div class="status">
                            <form action="http://localhost/www/TDUONG/thaygiao/hoc-sinh-huy-bai/" method="post" style="width:29%;display: inline-table;">
