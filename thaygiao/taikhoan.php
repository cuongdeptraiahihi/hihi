				...
				?>
                	<div>
                    	<div class="status">	
                         	<table class="table">
                            	<tr>
                                    <th style="border: none;"><input class='submit' type='submit' value='Tài khoản âm' onclick="location.href='http://localhost/www/TDUONG/thaygiao/tai-khoan/<?php echo $lmID; ?>/1/'" /></th>
                                    <th style="border: none;"><input class='submit' type='submit' value='Lợi nhuận âm' id="loi-nhuan-am" /></th>
                                    <th style="border: none;"><input class='submit' type='submit' value='Tất cả' onclick="location.href='http://localhost/www/TDUONG/thaygiao/tai-khoan/<?php echo $lmID; ?>/2/'" /></th>
                                ...
                                <?php
									...
									while($data=mysqli_fetch_assoc($result)) {
										...
										echo"
											...
											<td><input type='submit' class='submit' onclick=\"location.href='http://localhost/www/TDUONG/thaygiao/phat/$data[ID_HS]/'\" value='Xem' /></td>
											<td style='width:10%;'><span>Đã rút: ".format_money_vnd($da_rut)."</span></td>
											<td><span>Cần chi: ".format_money_vnd($con2)."</span></td>
											<td><input type='submit' class='submit' onclick=\"location.href='http://localhost/www/TDUONG/thaygiao/thuong/$data[ID_HS]/'\" value='Xem' /></td>
                        ...
                        <div class="page-number">
                            ...
                            <?php
								if($current!=1) {
									...
									echo"<li><a href='http://localhost/www/TDUONG/thaygiao/tai-khoan/page-$prev/'><</a></li>";
								}
								for($page=1;$page<=$sum_page;$page++) {
									$begin=($page-1)*$display;
									if($page==$current) {
										echo"<li><a href='http://localhost/www/TDUONG/thaygiao/tai-khoan/page-$begin/' style='font-weight:bold;text-decoration:underline;'>$page</a></li>";
									} else {
										echo"<li><a href='http://localhost/www/TDUONG/thaygiao/tai-khoan/page-$begin/'>$page</a></li>";
									}
								}
								if($current!=$sum_page) {
									$next=$position+$display;
									echo"<li><a href='http://localhost/www/TDUONG/thaygiao/tai-khoan/page-$next/'>></a></li>";
								}
							?>
                            </ul>
                        </div>
