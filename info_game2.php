    ...
    <div id="BODY">
        ...
        <div id="MAIN">
            ...
            <div class="main-div back animated bounceInUp" id="main-top">
                <div id="main-person">
                  <h1 style='line-height:98px;'>Thông tin phát vé</h1>
                    <div class="clear"></div>
                </div>
                <div id="main-avata">
            ...
            <div class="main-div animated bounceInUp">
                ...
                ?>
                <div class="main-1 back" style="border-bottom:none;border-bottom-left-radius:0;border-bottom-right-radius:0;"><h3><?php echo "Người mời:".$data6["fullname"]; ?></h3></div>
                <div id="main-table" class="main1-table" style="overflow: auto;">
                    <table class="table">
                        <?php
                        echo"<tr class='back tr-big'>
                            <th><span>$data6[name]</span></th>
                            <th><span>".str_replace("-"," lên ",$data6["class"])."</span></th>
                            <th><span>$data6[truong]</span></th>
                            <th><span>$data6[sdt]</span></th>
                            <th><span>$data6[sdt_phuhuynh]</span></th>
                        </tr>";
//                        if($data6["video"]) {
//                            ?>
